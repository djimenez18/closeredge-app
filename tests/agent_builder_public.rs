...
use closeredge_core::openhuman::context::prompt::SystemPromptBuilder;
use closeredge_core::openhuman::inference::provider::{ChatRequest, ChatResponse, Provider};
...
fn base_builder() -> closeredge_core::openhuman::agent::AgentBuilder {
    Agent::builder()
