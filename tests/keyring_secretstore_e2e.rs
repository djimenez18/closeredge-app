use closeredge_core::openhuman::config::schema::{Config, StreamMode, TelegramConfig};
use closeredge_core::openhuman::keyring;
...
async fn config_secrets_roundtrip_via_keyring_backed_master_key_migration() {
    ...
    let config = Config {
        ...
        search: closeredge_core::openhuman::config::schema::SearchConfig {
            parallel: closeredge_core::openhuman::config::schema::SearchEngineCredentials {
                api_key: Some("parallel-secret".into()),
                ..Default::default()
            },
            ..Default::default()
        },
        channels_config: closeredge_core::openhuman::config::schema::ChannelsConfig {
