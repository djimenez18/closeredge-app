...
use closeredge_core::openhuman::channels::providers::telegram::TelegramChannel;
...
use closeredge_core::openhuman::channels::providers::yuanbao::{
...
use closeredge_core::openhuman::channels::test_support::resolve_yuanbao_app_secret_for_test;
use closeredge_core::openhuman::channels::{Channel, SendMessage};
use closeredge_core::openhuman::config::Config;
use closeredge_core::openhuman::credentials::AuthService;
...
async fn web_start_chat_validation_forced_error_and_cancel_paths_are_structured() {
    assert_eq!(
        start_chat(" ", "thread", "hello", None, None, None, None)
            .await
            .unwrap_err(),
        "client_id is required"
    );
    assert_eq!(
        start_chat("client", " ", "hello", None, None, None, None)
            .await
            .unwrap_err(),
