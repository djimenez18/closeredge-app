...
pnpm run build:web
echo "Building standalone closeredge-core for web E2E into ${E2E_WEB_CORE_TARGET_DIR}..."
CARGO_TARGET_DIR="$E2E_WEB_CORE_TARGET_DIR" cargo build --manifest-path "$REPO_ROOT/Cargo.toml" --bin closeredge-core
