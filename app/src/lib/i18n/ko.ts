...
const messages: TranslationMap = {
  ...
  'welcome.title': 'CloserEdge AI에 오신 것을 환영합니다',
  ...
  'welcome.resetErrorFallback':
    '앱 데이터를 지울 수 없습니다. CloserEdge AI을 종료하고 다시 열어 재시도하세요.',
  ...
  'home.statusCoreUnreachable':
    '로컬 코어 사이드카가 응답하지 않습니다. CloserEdge AI 백그라운드 프로세스가 중단되었거나 시작하지 못했을 수 있습니다.',
  'home.statusInternetOffline':
    '현재 기기가 오프라인 상태입니다. 네트워크를 확인하거나 앱을 다시 시작하여 다시 연결하세요.',
  'home.statusBrowserMode':
    '브라우저 미리보기 모드로 실행 중입니다. 데스크톱 앱을 설치하면 전체 기능을 사용할 수 있습니다.',
  ...
  'alerts.unread': '읽지 않음',
  'onboarding.welcome': '안녕하세요. 저는 CloserEdge AI입니다.',
  ...
  'onboarding.finishDesc': '모든 준비가 끝났습니다! CloserEdge AI을 사용해 보세요.',
  'onboarding.skip': '건너뛰기',
  'onboarding.getStarted': '시작하기',
  'onboarding.runtimeChoice.title': 'CloserEdge AI을 어떻게 실행하시겠습니까?',
  'onboarding.runtimeChoice.subtitle':
    '가장 잘 맞는 설정을 선택하세요. 나중에 설정에서 변경할 수 있습니다.',
  'onboarding.runtimeChoice.cloud.title': '간단 모드',
  'onboarding.runtimeChoice.cloud.tagline': 'CloserEdge AI이 모든 것을 대신 관리하도록 합니다.',
  ...
  'onboarding.custom.defaultSubtitle': 'CloserEdge AI이 대신 관리하도록 합니다.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'CloserEdge AI은 모든 작업을 적절한 기본 모델로 라우팅합니다. 키도 필요 없고 설정도 필요 없습니다.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'CloserEdge AI에는 바로 사용할 수 있는 관리형 STT/TTS가 포함되어 있습니다. 별도로 연결할 필요가 없습니다.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'CloserEdge AI은 관리형 Composio 워크스페이스를 실행합니다. 나중에 각 서비스를 한 번의 클릭으로 연결할 수 있습니다.',
  ...
  'onboarding.custom.search.subtitle': 'CloserEdge AI이 사용자를 대신해 웹을 검색하는 방식입니다.',
  'onboarding.custom.search.defaultDesc':
    'CloserEdge AI은 관리형 검색 백엔드를 사용합니다. 키가 필요 없습니다.',
  'onboarding.custom.search.configureDesc':
    '직접 검색 제공업체 키(Tavily, Brave 등)를 가져오세요. 설정 › 도구에서 구성할 수 있습니다.',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'CloserEdge AI이 시맨틱 메모리 검색을 위한 벡터 임베딩을 생성하는 방식입니다.',
  'onboarding.custom.embeddings.defaultDesc':
    'CloserEdge AI이 관리형 임베딩 서비스를 사용합니다. API 키가 필요 없습니다.',
  ...
  'onboarding.custom.memory.subtitle':
    'CloserEdge AI이 사용자의 컨텍스트, 선호도, 이전 대화를 기억하는 방식입니다.',
  'onboarding.custom.memory.defaultDesc':
    'CloserEdge AI은 메모리 저장과 검색을 자동으로 관리합니다. 설정할 것이 없습니다.',
  ...
  'misc.beta':
    'CloserEdge AI은 초기 베타 버전입니다. 피드백을 공유하거나 발견한 버그를 신고해 주세요 — 모든 신고는 더 빠른 출시를 돕습니다.',
  ...
  'privacy.shareAnonymizedDataDesc':
    '익명 충돌 보고서와 사용 분석을 공유하여 CloserEdge AI 개선을 도와주세요. 모든 데이터는 완전히 익명화되며, 개인 데이터, 메시지, 지갑 키 또는 세션 정보는 절대 수집되지 않습니다.',
  'privacy.meetingFollowUps': '회의 후속 조치',
  'privacy.autoHandoffMeet': 'Google Meet transcript를 오케스트레이터에 자동 전달',
  'privacy.autoHandoffMeetDesc':
    'Google Meet 통화가 끝나면 CloserEdge AI의 오케스트레이터가 transcript를 읽고 메시지 초안 작성, 후속 일정 예약, 연결된 Slack 워크스페이스에 요약 게시 같은 작업을 수행할 수 있습니다. 기본값은 꺼짐입니다.',
  ...
  'settings.search.menuDesc':
    'CloserEdge AI 관리 검색을 기본값으로 사용하거나 API 키로 자체 제공업체를 연결하세요.',
  'settings.search.description':
    '에이전트가 사용할 검색 엔진을 선택하거나 검색 도구를 완전히 비활성화합니다. 관리형은 CloserEdge AI의 백엔드를 사용합니다(설정 불필요). 병렬, Brave, Querit은 API 키를 사용하여 내 컴퓨터에서 직접 실행됩니다.',
  'settings.search.engineAria': '검색 엔진',
  'settings.search.engineDisabledLabel': 'Disabled',
  'settings.search.engineDisabledDesc':
    '에이전트 컨텍스트 및 사용 가능한 도구 목록에서 검색 도구를 제거합니다.',
  'settings.search.engineManagedLabel': 'CloserEdge AI 관리됨',
  'settings.search.engineManagedDesc':
    '기본값입니다. CloserEdge AI 백엔드를 통해 라우팅되며 API 키가 필요하지 않습니다.',
  'settings.search.localManagedUnavailable':
    '로컬 사용자는 CloserEdge AI 관리 검색을 사용할 수 없습니다. 웹 검색을 활성화하려면 자체 Parallel, Brave 또는 Querit API 키를 추가하세요.',
  ...
  'devices.betaText':
    '이 기능은 현재 베타 버전입니다. iOS 기기를 이 CloserEdge AI과 페어링하여 원격 클라이언트로 사용할 수 있습니다.',
  ...
  'devices.emptyState': 'iPhone에서 QR code을 스캔하여 이 CloserEdge AI 세션에 연결하세요.',
  ...
  'devices.pairModal.instructions': 'iPhone에서 CloserEdge AI 앱을 열고 이 코드를 스캔하세요.',
  ...
  'autonomy.maxActionsHelp':
    '에이전트가 롤링 1시간 동안 실행할 수 있는 최대 도구 작업 수입니다. 새 값은 다음 채팅부터 적용됩니다. 크론 작업 및 채널 리스너는 CloserEdge AI을 재시작할 때까지 현재 제한을 유지합니다.',
  ...
  'settings.tools.chooseCapabilities':
    'CloserEdge AI이 사용자를 대신해 사용할 수 있는 기능을 선택하세요.',
  ...
  'voice.providers.chip.cloud': 'CloserEdge AI (관리형)',
  'voice.providers.chip.cloudAria': 'CloserEdge AI 관리형 공급자는 항상 활성화되어 있습니다',
  ...
  'bootCheck.desktopDescription':
    'CloserEdge AI은 생각하기 위한 런타임이 필요합니다. 어디에서 실행할지 선택하세요.',
  'bootCheck.webDescription':
    '웹에서 CloserEdge AI은 사용자가 제어하는 런타임에 연결됩니다. 아래에 URL과 인증 토큰을 입력하거나, 데스크톱 앱을 받아 이 컴퓨터에서 바로 실행하세요.',
  ...
  'bootCheck.legacyDescription':
    '별도로 설치된 CloserEdge AI 데몬이 이 기기에서 이미 실행 중입니다. 내장 런타임이 대신 실행되기 전에 이를 정리해야 합니다.',
  ...
  'bootCheck.portConflictBody':
    '다른 프로세스가 CloserEdge AI에 필요한 네트워크 포트를 사용 중입니다. 자동으로 문제를 해결해 드리겠습니다.',
  ...
  'composio.expiredDescription':
    '{name} 도구를 다시 활성화하려면 다시 연결하세요. CloserEdge AI은 OAuth 액세스를 새로 고칠 때까지 이 통합을 사용할 수 없는 상태로 유지합니다.',
  ...
  'app.connectionIndicator.connected': 'CloserEdge AI에 연결됨 🚀',
  ...
  'app.connectionIndicator.browserMode': '브라우저 모드',
  ...
  'app.openhumanLink.notifications.sent':
    '테스트 알림이 전송되었습니다. 받지 못했다면 시스템 설정 → 알림 → CloserEdge AI으로 이동해 알림 허용을 켜고 배너 스타일을 지속으로 설정하세요.',
  ...
  'app.routeLoading.initializing': 'CloserEdge AI 초기화 중...',
  ...
  'channels.authMode.managed_dm': 'CloserEdge AI로 로그인',
  ...
  'channels.discord.authMode.oauth.description':
    'OAuth을 통해 CloserEdge AI 봇을 Discord 서버에 설치합니다.',
  'channels.discord.authMode.managed_dm.description':
    '개인 Discord 계정을 CloserEdge AI 봇에 연결하세요.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'CloserEdge AI Telegram 봇에게 직접 메시지를 보냅니다.',
  ...
  'iosPair.error.invalidQr':
    '유효하지 않은 QR 코드입니다. CloserEdge AI 페어링 코드를 스캔하고 있는지 확인하세요.',
  ...
  'iosPair.instructions':
    '데스크탑에서 CloserEdge AI을 열고 설정 > 기기로 이동한 후 "기기 페어링"을 탭하여 QR 코드를 표시하세요.',
  'iosPair.retryScan': '스캔 재시도',
  'iosPair.scanQrCode': '스캔 QR code',
  'iosPair.scannerOpening': '스캐너 여는 중...',
  'iosPair.step.openDesktop': '데스크톱에서 CloserEdge AI 열기',
  ...
  'composio.connect.permissionsNoteSuffix':
    'CloserEdge AI 자체 에이전트 권한은 아래에서 읽기, 쓰기, 관리자 토글로 제어됩니다.',
  ...
  'daemon.serviceBlockingGate.title': 'CloserEdge AI 코어를 사용할 수 없습니다',
  'home.banners.communitySubtitle': '지원을 받고, 피드백을 공유하고, 다른 사용자들과 소통하세요.',
  'home.banners.communityTitle': '커뮤니티에 참여하세요',
  ...
  'home.banners.promoCreditsBody': 'CloserEdge AI을 사용해 보고, 더 필요할 때',
  ...
  'intelligence.diagram.imageAlt': '최신 생성된 CloserEdge AI 아키텍처 다이어그램',
  ...
  'overlay.ariaOrb': 'CloserEdge AI 오버레이',
  ...
  'settings.ai.openhumanDefault': 'CloserEdge AI(기본값)',
  ...
  'settings.ai.routing.managedDesc':
    'CloserEdge AI이 모든 추론을 클라우드에서 실행하고, 작업에 가장 적합한 모델을 선택하며, 비용을 최적화하고 가장 안전한 라우팅 기본값을 유지합니다.',
  'settings.ai.routing.managedMsg':
    'CloserEdge AI이 모든 워크로드의 추론을 처리하고 비용, 품질, 보안을 고려해 최적의 경로를 자동으로 선택합니다.',
  ...
  'settings.composio.confirmWarning':
    '기존 통합(Gmail, Slack, GitHub 등 CloserEdge AI을 통해 연결된 통합)은 표시되지 않습니다 — CloserEdge AI 관리형 Composio 테넌트에 있습니다.',
  ...
  'settings.composio.modeManaged': '관리형(CloserEdge AI이 대신 처리)',
  'settings.composio.modeManagedDesc':
    'CloserEdge AI이 백엔드를 통해 도구 호출을 프록시합니다(권장). 인증은 중개되며, Composio API 키를 붙여넣을 필요가 없습니다. 웹훅은 완전히 라우팅됩니다.',
  ...
  'settings.localModel.download.summaryHelper':
    'Rust 코어를 통해 `closeredge.inference_summarize`를 호출합니다.',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'CloserEdge AI은 이제 Ollama를 외부 추론 런타임으로 취급합니다. 직접 Ollama 서버를 시작하고 원하는 모델을 가져온 뒤 작업 라우팅을 해당 서버로 지정하세요.',
  ...
  'settings.developerMenu.tools.desc':
    'CloserEdge AI이 사용자를 대신하여 사용할 수 있는 기능 활성화 또는 비활성화',
  ...
  'settings.developerMenu.mcpServer.desc': 'CloserEdge AI에 연결하도록 외부 MCP 클라이언트 구성',
  ...
  'settings.mcpServer.toolsSectionDesc':
    '도구 노출 closeredge-core mcp 실행 시 MCP stdio 서버를 통해',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'CloserEdge AI 바이너리를 찾을 수 없습니다. 소스에서 실행하는 경우 다음을 사용하여 빌드하세요: cargo build --bin closeredge-core',
  ...
  'settings.memoryWindow.description':
    'CloserEdge AI이 새 에이전트 실행마다 주입하는 기억된 컨텍스트의 양입니다. 창이 클수록 과거 대화를 더 잘 인식하지만, 매 실행마다 더 많은 토큰을 사용하고 비용도 더 듭니다.',
  ...
  'skills.create.scopeUserHint':
    '~/.closeredge/skills/<slug>/SKILL.md에 작성됨 — 모든 워크스페이스에서 사용 가능.',
  ...
  'skills.install.errors.writeFailedHint':
    '작업공간 기술 디렉터리에 쓸 수 없습니다. `<workspace>/.closeredge/skills/`에 대한 파일 시스템 권한을 확인하세요.',
  ...
  'skills.meetingBots.bannerDesc':
    'Google Meet 링크를 넣으면 CloserEdge AI이 게스트로 참여하여 말하고, 듣고, 반응합니다.',
  'skills.meetingBots.bannerTitle': 'CloserEdge AI을 회의에 보내기',
  'skills.meetingBots.busyTitle': 'CloserEdge AI이 바쁩니다',
  'skills.meetingBots.comingSoon': '곧 제공 예정',
  'skills.meetingBots.couldNotStartTitle': 'CloserEdge AI을 시작할 수 없습니다',
  'skills.meetingBots.displayName': '표시 이름',
  'skills.meetingBots.failedToStart': 'CloserEdge AI 시작에 실패했습니다.',
  'skills.meetingBots.joiningMessage': '몇 초 안에 참가자로 표시될 것입니다.',
  'skills.meetingBots.joiningTitle': 'CloserEdge AI이 회의에 참여하는 중',
  'skills.meetingBots.meetingLink': '회의 링크',
  'skills.meetingBots.modalAriaLabel': 'CloserEdge AI을 회의에 보내기',
  'skills.meetingBots.modalDesc':
    'CloserEdge AI이 익명 게스트로 참여하여 비디오를 통화에 스트리밍하고 에이전트를 통해 응답합니다.',
  'skills.meetingBots.modalTitle': 'CloserEdge AI을 회의에 보내기',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'CloserEdge AI 외부에서 Ollama 프로세스와 모델 가져오기를 관리한 다음 진단을 다시 실행하세요.',
  ...
  'devOptions.menuToolsDesc':
    'CloserEdge AI이(가) 사용자를 대신하여 사용할 수 있는 기능 활성화 또는 비활성화',
  ...
  'keyring.consent.description':
    '운영 체제 키체인에 접근할 수 없습니다. CloserEdge AI이 로컬 암호화 저장소를 사용하여 비밀을 저장하려면 귀하의 허가가 필요합니다.',
  ...
  'mobile.tab.home': '홈',
  'mobile.tab.chat': '채팅',
  'mobile.tab.settings': '설정',
  'mobileHome.greeting.morning': '좋은 아침이에요',
  'mobileHome.greeting.afternoon': '좋은 오후예요',
  'mobileHome.greeting.evening': '좋은 저녁이에요',
  'mobileHome.themeToggle': '다크 모드 전환',
  'mobileHome.status.title': '내 데스크톱',
  'mobileHome.status.checking': '확인 중…',
  'mobileHome.status.online': '연결됨',
  'mobileHome.status.offline': '연결할 수 없음',
  'mobileHome.status.manage': '관리',
  'mobileHome.transport.lan': '로컬 네트워크',
  'mobileHome.transport.tunnel': '보안 터널',
  'mobileHome.transport.cloud': '클라우드 릴레이',
  'mobileHome.cta.title': 'AI와 대화하기',
  'mobileHome.cta.subtitle': '눌러서 말하거나 입력하세요. 당신의 강점이 한 번의 탭에.',
  'mobileHome.suggestions.title': '이렇게 물어보세요',
  'mobileHome.suggestion.listing': '매물 설명 작성하기',
  'mobileHome.suggestion.followup': '고객 후속 메시지 작성하기',
  'mobileHome.suggestion.plan': '하루 계획 세우기',
  'mobileDevices.subtitle': '이 휴대폰과 페어링된 데스크톱.',
  'mobileDevices.pairAnother': '다른 기기 페어링',
  'mobileDevices.empty': '아직 페어링된 데스크톱이 없습니다.',
  'mobileWelcome.tagline': '주머니 속 AI 직원.',
  'mobileWelcome.logIn': '로그인',
  'mobileWelcome.scanQr': 'QR 코드로 페어링',
  'mobileWelcome.hint':
    '로그인하여 데스크톱과 클라우드 에이전트에 연결하거나, 컴퓨터의 CloserEdge AI에서 QR 코드를 스캔하세요.',
  'mobileLogin.title': '로그인',
  'mobileLogin.pickDesktop': '데스크톱 선택',
  'mobileLogin.email': '이메일',
  'mobileLogin.password': '비밀번호',
  'mobileLogin.signingIn': '로그인 중…',
  'mobileLogin.loadingDesktops': '데스크톱을 찾는 중…',
  'mobileLogin.noDesktops':
    '아직 계정에서 데스크톱을 찾을 수 없습니다. 컴퓨터에서 CloserEdge AI를 열고 설정 → 기기에서 클라우드 페어링을 켜세요.',
  'mobileLogin.useQrInstead': '대신 QR 코드로 페어링',
  'mobileLogin.desktopOnline': '연결 준비됨',
  'mobileLogin.desktopOffline': '오프라인 — 이 컴퓨터에서 CloserEdge를 여세요',
  'mobileLogin.connecting': '{label}에 연결 중…',
  'mobileLogin.error.expired':
    '이 데스크톱이 최근에 새로고침되지 않았습니다 — CloserEdge AI가 실행 중인지 확인한 후 다시 시도하세요.',
  'mobileLogin.error.unreachable': '해당 데스크톱에 연결할 수 없습니다. 온라인 상태인가요?',
  'devices.cloudPairing.title': '클라우드 페어링',
  'devices.cloudPairing.body':
    'CloserEdge 계정에 로그인한 휴대폰이 QR 코드를 스캔하지 않고 연결할 수 있도록 합니다.',
