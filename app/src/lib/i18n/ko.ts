...
const messages: TranslationMap = {
  ...
  'rewards.localUnavailable':
    '로컬 로그인은 리워드, 쿠폰 또는 추천 크레딧을 적립할 수 없습니다. 리워드를 적립하려면 로그아웃하고 CloserEdge AI 계정으로 로그인하세요.',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'CloserEdge AI 바이너리를 찾을 수 없습니다. 소스에서 실행하는 경우 다음을 사용하여 빌드하세요: cargo build --bin openhuman-core',
  ...
  'settings.mascot.colorAria': 'CloserEdge AI 색상',
  ...
  'settings.mascot.libraryUnavailable': 'CloserEdge AI 라이브러리를 사용할 수 없음',
  'settings.mascot.title': 'CloserEdge AI',
  'settings.mascot.loadingLibrary': 'CloserEdge AI 라이브러리 불러오는 중…',
  'settings.mascot.loadDetailError': '마스코트를 로드할 수 없습니다.',
  'settings.mascot.loadLibraryError': '마스코트 라이브러리를 로드할 수 없습니다.',
  'settings.mascot.localDefault': '로컬 CloserEdge AI(기본값)',
  'settings.mascot.menuTitle': '마스코트',
  'settings.mascot.menuDesc': '앱 전체에서 사용되는 마스코트 색상 선택',
  'settings.mascot.noCharacters': '아직 사용할 수 있는 CloserEdge AI 캐릭터가 없습니다',
  ...
  'settings.mascot.noCharactersAvailable': '아직 사용할 수 있는 CloserEdge AI 캐릭터가 없습니다',
