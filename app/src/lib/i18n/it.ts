...
const messages: TranslationMap = {
  ...
  'welcome.title': 'Benvenuto in CloserEdge AI',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    "Impossibile cancellare i dati dell'app. Chiudi e riapri CloserEdge AI, poi riprova.",
  ...
  'home.statusCoreUnreachable':
    'Il sidecar core locale non risponde. Il processo in background di CloserEdge AI potrebbe essersi bloccato o non essere partito.',
  'home.statusInternetOffline':
    "Il tuo dispositivo è offline. Controlla la rete o riavvia l'app per riconnetterti.",
  'home.statusBrowserMode':
    "In esecuzione in modalita anteprima browser. Installa l'app desktop per l'esperienza completa.",
  ...
  'onboarding.welcome': 'Ciao. Sono CloserEdge AI.',
  ...
  'onboarding.finishDesc': 'Tutto pronto! Inizia a usare CloserEdge AI.',
  'onboarding.skip': 'Salta',
  'onboarding.getStarted': 'Inizia',
  'onboarding.runtimeChoice.title': 'Come vuoi eseguire CloserEdge AI?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Lascia che CloserEdge AI gestisca tutto per te.',
  ...
  'onboarding.custom.defaultSubtitle': 'Lascia che CloserEdge AI lo gestisca per te.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'CloserEdge AI instrada ogni carico di lavoro a un modello predefinito sensato. Niente chiavi, niente configurazione.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'CloserEdge AI include STT/TTS gestiti che funzionano subito. Niente da configurare.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'CloserEdge AI gestisce un workspace Composio gestito. Un clic per connettere ogni servizio in seguito.',
  ...
  'onboarding.custom.search.subtitle': 'Come CloserEdge AI cerca sul web per tuo conto.',
  'onboarding.custom.search.defaultDesc':
    'CloserEdge AI usa un backend di ricerca gestito. Nessuna chiave necessaria.',
  'onboarding.custom.search.configureDesc':
    'Porta la tua chiave di provider di ricerca (Tavily, Brave, ecc.). Configura in Impostazioni › Strumenti.',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'Come CloserEdge AI genera gli embedding vettoriali per la ricerca nella memoria semantica.',
  'onboarding.custom.embeddings.defaultDesc':
    'CloserEdge AI utilizza un servizio di embedding gestito. Nessuna chiave API necessaria.',
  ...
  'onboarding.custom.memory.subtitle':
    'Come CloserEdge AI ricorda il tuo contesto, le preferenze e le conversazioni precedenti.',
  'onboarding.custom.memory.defaultDesc':
    "CloserEdge AI gestisce automaticamente l'archiviazione e il recupero della memoria. Niente da configurare.",
  ...
  'invites.statusExpired': 'Stato scaduto',
  ...
  'misc.beta':
    'CloserEdge AI è in beta iniziale. Sentiti libero di condividere feedback o segnalare bug che incontri — ogni segnalazione ci aiuta a rilasciare più velocemente.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Aiuta a migliorare CloserEdge AI condividendo report di crash anonimi e analisi di utilizzo. Tutti i dati sono completamente anonimizzati — nessun dato personale, messaggio, chiave wallet o informazione di sessione viene mai raccolto.',
  ...
  'privacy.autoHandoffMeetDesc':
    "Quando termina una chiamata Google Meet, l'orchestratore di CloserEdge AI può leggere la trascrizione e svolgere azioni come redigere messaggi, pianificare follow-up o pubblicare riassunti nel tuo workspace Slack connesso. Disattivato di default.",
  ...
  'settings.search.menuDesc':
    'Imposta come predefinito la ricerca gestita da CloserEdge AI oppure collega il tuo provider con una chiave API.',
  'settings.search.description':
    "Scegli il motore di ricerca utilizzato dall'agente oppure disabilita completamente gli strumenti di ricerca. Gestito utilizza il backend di CloserEdge AI (nessuna configurazione). Parallelo, Brave e Querit vengono eseguiti direttamente dalla tua macchina usando la tua chiave API.",
  ...
  'settings.search.engineManagedLabel': 'CloserEdge AI Gestito',
  'settings.search.engineManagedDesc':
    'Predefinito. Instradato tramite il backend CloserEdge AI — nessuna chiave API necessaria.',
  'settings.search.localManagedUnavailable':
    'La ricerca gestita da CloserEdge AI non è disponibile per gli utenti locali. Aggiungi la tua chiave API Parallel o Brave per abilitare la ricerca web.',
  ...
  'devices.betaText':
    'Questa funzionalità è attualmente in beta. Associa i telefoni iOS a questo CloserEdge AI per usarli come client remoto.',
  ...
  'devices.emptyState':
    'Scansiona un codice QR sul tuo iPhone per collegarlo a questa sessione CloserEdge AI.',
  ...
  'devices.pairModal.instructions':
    "Apri l'app CloserEdge AI sul tuo iPhone e scansiona questo codice.",
  ...
  'autonomy.maxActionsHelp':
    'Numero massimo di azioni dello strumento che un agente può eseguire per ora continuativa. Il nuovo valore si applica alla prossima chat. I cron job e i listener dei canali mantengono il limite attuale fino al riavvio di CloserEdge AI.',
  ...
  'settings.tools.chooseCapabilities':
    'Scegli quali capacità CloserEdge AI può usare per tuo conto.',
  ...
  'voice.providers.chip.cloud': 'CloserEdge AI (Gestito)',
  'voice.providers.chip.cloudAria': 'Il provider gestito da CloserEdge AI è sempre abilitato',
  ...
  'backend.cloudDescription':
    "Modelli veloci e potenti instradati attraverso il backend di CloserEdge AI. Pronti all'uso immediatamente.",
  'backend.privacyNote':
  ...
  'bootCheck.desktopDescription':
    'CloserEdge AI ha bisogno di un runtime per pensare. Scegli dove farlo girare.',
  'bootCheck.webDescription':
    "Sul web, CloserEdge AI si connette a un runtime che controlli tu. Inserisci sotto URL e token di autenticazione, oppure scarica l'app desktop per farne girare uno direttamente sulla tua macchina.",
  ...
  'bootCheck.legacyDescription':
    'Un daemon CloserEdge AI installato separatamente è già in esecuzione su questo dispositivo. Dobbiamo rimuoverlo prima che il runtime integrato possa subentrare.',
  ...
  'bootCheck.portConflictBody':
    'Un altro processo sta usando la porta di rete necessaria a CloserEdge AI. Tenteremo di risolvere il problema automaticamente.',
  ...
  'composio.expiredDescription':
    "Riconnettiti per riattivare gli strumenti {name}. CloserEdge AI manterrà questa integrazione non disponibile finché non aggiornerai l'accesso a OAuth.",
  ...
  'app.connectionIndicator.connected': 'Connesso a CloserEdge AI 🚀',
  ...
  'app.connectionIndicator.browserMode': 'Modalita browser',
  ...
  'app.openhumanLink.notifications.sent':
    "Notifica di test inviata. Se non l'hai ricevuta, vai in Impostazioni di Sistema → Notifiche → CloserEdge AI, attiva Consenti notifiche e imposta lo Stile banner su Persistente.",
  ...
  'app.routeLoading.initializing': 'Inizializzazione di CloserEdge AI...',
  ...
  'channels.authMode.managed_dm': 'Accedi con CloserEdge AI',
  ...
  'channels.discord.authMode.oauth.description':
    'Installa il bot CloserEdge AI sul tuo server Discord tramite OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Collega il tuo account personale Discord al bot CloserEdge AI.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Invia un messaggio direttamente al bot CloserEdge AI Telegram.',
  ...
  'iosPair.error.invalidQr':
    'Codice QR non valido. Assicurati di scansionare un codice di abbinamento CloserEdge AI.',
  ...
  'iosPair.instructions':
    'Apri CloserEdge AI sul desktop, vai in Impostazioni > Dispositivi e tocca "Associa telefono" per mostrare il codice QR.',
  'iosPair.retryScan': 'Riprova la scansione',
  'iosPair.scanQrCode': 'Scansione QR code',
  'iosPair.scannerOpening': 'Apertura scanner...',
  'iosPair.step.openDesktop': 'Apri CloserEdge AI sul desktop',
  ...
  'composio.connect.permissionsNoteSuffix':
    "Le autorizzazioni proprie dell'agente CloserEdge AI sono controllate sotto come toggle di lettura, scrittura e admin.",
  ...
  'daemon.serviceBlockingGate.title': 'Il core di CloserEdge AI non è disponibile',
  'home.banners.communitySubtitle':
    'Ricevi supporto, condividi feedback e connettiti con altri utenti.',
  'home.banners.communityTitle': 'Unisciti alla nostra community',
  ...
  'intelligence.diagram.imageAlt': "Ultimo diagramma dell'architettura CloserEdge AI generato",
  ...
  'settings.ai.openhumanDefault': 'CloserEdge AI (predefinito)',
  ...
  'settings.ai.routing.managedDesc':
    'CloserEdge AI eseguirà tutte le inferenze nel cloud, sceglierà il miglior modello per il compito, ottimizzerà i costi e manterrà le impostazioni di routing più sicure.',
  'settings.ai.routing.managedMsg':
    'CloserEdge AI gestirà tutte le inferenze per ogni carico di lavoro e sceglierà automaticamente il percorso migliore in termini di costo, qualità e sicurezza.',
  ...
  'settings.composio.confirmWarning':
    'Le tue integrazioni esistenti (Gmail, Slack, GitHub, ecc. collegate tramite CloserEdge AI) non saranno visibili — risiedono nel tenant Composio gestito da CloserEdge AI.',
  ...
  'settings.composio.modeManaged': 'Gestita (CloserEdge AI lo gestisce per te)',
  'settings.composio.modeManagedDesc':
    "CloserEdge AI fa da proxy per le chiamate degli strumenti tramite il nostro backend (consigliato). L'autenticazione è mediata; non incolli mai una chiave API Composio. I webhook sono completamente instradati.",
  ...
  'settings.localModel.download.summaryHelper':
    'Chiama `closeredge.inference_summarize` tramite Rust core',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    "CloserEdge AI ora tratta Ollama come un runtime di inferenza esterno. Avvia il tuo server Ollama, scarica i modelli che vuoi e punta l'instradamento dei carichi di lavoro su di esso.",
  ...
  'settings.developerMenu.tools.desc':
    'Abilita o disabilita le capacità che CloserEdge AI può usare per tuo conto',
  ...
  'settings.developerMenu.mcpServer.desc':
    'Configura i client MCP esterni per connettersi a CloserEdge AI',
  ...
  'settings.mcpServer.toolsSectionDesc':
    "Strumenti esposti tramite il server MCP stdio durante l'esecuzione di closeredge-core mcp",
  ...
  'settings.mcpServer.binaryPathNotFound':
    'CloserEdge AI binario non trovato. Se esegui dal sorgente, compila con: cargo build --bin closeredge-core',
  ...
  'settings.memoryWindow.description':
    "Quanto contesto ricordato CloserEdge AI inietta in ogni nuova esecuzione dell'agente. Finestre più grandi fanno sentire l'agente più consapevole delle conversazioni passate ma usano più token — e costano di più — a ogni esecuzione.",
  ...
  'skills.create.scopeUserHint':
    'Scritto in ~/.closeredge/skills/<slug>/SKILL.md — disponibile in tutti i workspace.',
  ...
  'skills.install.errors.writeFailedHint':
    "La directory delle competenze dell'area di lavoro non era scrivibile. Controlla i permessi del filesystem per `<workspace>/.closeredge/skills/`.",
  ...
  'skills.meetingBots.busyTitle': 'CloserEdge AI è occupato',
  'skills.meetingBots.comingSoon': 'In arrivo',
  'skills.meetingBots.couldNotStartTitle': 'Impossibile avviare CloserEdge AI',
  'skills.meetingBots.displayName': 'Nome visualizzato',
  'skills.meetingBots.failedToStart': 'Avvio di CloserEdge AI fallito.',
  'skills.meetingBots.joiningMessage': 'Apparirà come partecipante tra qualche secondo.',
  'skills.meetingBots.joiningTitle': 'CloserEdge AI si sta unendo alla riunione',
  'skills.meetingBots.meetingLink': 'Link della riunione',
  'skills.meetingBots.modalAriaLabel': 'Invia CloserEdge AI a una riunione',
  'skills.meetingBots.modalDesc': 'Descrizione modale',
  'skills.meetingBots.modalTitle': 'Invia CloserEdge AI a una riunione',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'Gestisci il processo Ollama e i pull dei modelli al di fuori di CloserEdge AI, poi riesegui la diagnostica.',
  ...
  'devOptions.menuToolsDesc':
    'Abilita o disabilita le funzionalità che CloserEdge AI può utilizzare per tuo conto',
  ...
  'keyring.consent.description':
    "Il portachiavi del sistema operativo non è accessibile. CloserEdge AI necessita del tuo permesso per archiviare i segreti utilizzando l'archiviazione locale crittografata.",
  ...
  'mobile.tab.settings': 'Impostazioni',
  'mobileHome.greeting.morning': 'Buongiorno',
  'mobileHome.greeting.afternoon': 'Buon pomeriggio',
  'mobileHome.greeting.evening': 'Buonasera',
  'mobileHome.themeToggle': 'Attiva/disattiva modalità scura',
  'mobileHome.status.title': 'Il tuo desktop',
  'mobileHome.status.checking': 'Verifica in corso…',
  'mobileHome.status.online': 'Connesso',
  'mobileHome.status.offline': 'Non raggiungibile',
  'mobileHome.status.manage': 'Gestisci',
  'mobileHome.transport.lan': 'Rete locale',
  'mobileHome.transport.tunnel': 'Tunnel sicuro',
  'mobileHome.transport.cloud': 'Relay cloud',
  'mobileHome.cta.title': 'Parla con la tua IA',
  'mobileHome.cta.subtitle':
    'Tieni premuto per parlare o scrivi. Il tuo vantaggio, a un tocco di distanza.',
  'mobileHome.suggestions.title': 'Prova a chiedere',
  'mobileHome.suggestion.listing': 'Scrivere la descrizione di un annuncio',
  'mobileHome.suggestion.followup': 'Scrivere un follow-up per un cliente',
  'mobileHome.suggestion.plan': 'Pianificare la mia giornata',
  'mobileDevices.subtitle': 'Desktop abbinati a questo telefono.',
  'mobileDevices.pairAnother': 'Abbina un altro dispositivo',
  'mobileDevices.empty': 'Nessun desktop ancora abbinato.',
  'mobileWelcome.tagline': 'Il tuo dipendente IA, in tasca.',
  'mobileWelcome.logIn': 'Accedi',
  'mobileWelcome.scanQr': 'Abbina con codice QR',
  'mobileWelcome.hint':
    'Accedi per collegarti ai tuoi desktop e agenti cloud, oppure scansiona il codice QR da CloserEdge AI sul tuo computer.',
  'mobileLogin.title': 'Accedi',
  'mobileLogin.pickDesktop': 'Scegli un desktop',
  'mobileLogin.email': 'Email',
  'mobileLogin.password': 'Password',
  'mobileLogin.signingIn': 'Accesso in corso…',
  'mobileLogin.loadingDesktops': 'Ricerca dei tuoi desktop…',
  'mobileLogin.noDesktops':
    "Nessun desktop trovato sul tuo account. Apri CloserEdge AI sul computer e attiva l'abbinamento cloud in Impostazioni → Dispositivi.",
  'mobileLogin.useQrInstead': 'Abbina invece con codice QR',
  'mobileLogin.desktopOnline': 'Pronto a connettersi',
  'mobileLogin.desktopOffline': 'Offline — apri CloserEdge su questo computer',
  'mobileLogin.connecting': 'Connessione a {label}…',
  'mobileLogin.error.expired':
    'Questo desktop non si è aggiornato di recente — assicurati che CloserEdge AI sia in esecuzione, poi riprova.',
  'mobileLogin.error.unreachable': 'Impossibile raggiungere quel desktop. È online?',
  'devices.cloudPairing.title': 'Abbinamento cloud',
  'devices.cloudPairing.body':
    'Consenti ai telefoni collegati al tuo account CloserEdge di connettersi senza scansionare un codice QR.',
