...
const messages: TranslationMap = {
  ...
  'home.statusBrowserMode':
    'ব্রাউজার প্রিভিউ মোডে চলছে। সম্পূর্ণ অভিজ্ঞতার জন্য ডেস্কটপ অ্যাপ ইনস্টল করুন।',
  ...
  'invites.statusExpired': 'স্ট্যাটাস মেয়াদোত্তীর্ণ',
  ...
  'settings.search.localManagedUnavailable':
    'লোকাল ব্যবহারকারীদের জন্য CloserEdge AI Managed সার্চ উপলভ্য নয়। ওয়েব সার্চ চালু করতে আপনার নিজের Parallel বা Brave API key যোগ করুন।',
  ...
  'app.connectionIndicator.browserMode': 'ব্রাউজার মোড',
  ...
  'settings.localModel.download.summaryHelper':
    'রাস্ট কোরের মাধ্যমে `closeredge.inference_summarize` কল করে',
  ...
  'settings.mcpServer.toolsSectionDesc': 'উপলভ্য টুলস stdio সার্ভার যখন closeredge-core mcp',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'CloserEdge AI বাইনারি পাওয়া যায়নি। উৎস থেকে চললে, এর সাথে তৈরি করুন: cargo build --bin closeredge-core',
  ...
  'skills.create.scopeUserHint':
    '~/.closeredge/skills/<slug>/SKILL.md-এ লেখা — সব ওয়ার্কস্পেসে পাওয়া যায়।',
  ...
  'skills.install.errors.writeFailedHint':
    'ওয়ার্কস্পেস দক্ষতা ডিরেক্টরি লেখার যোগ্য ছিল না। `<workspace>/.closeredge/skills/`-এর জন্য ফাইল সিস্টেমের অনুমতি পরীক্ষা করুন।',
  ...
  'mobile.tab.home': 'হোম',
  'mobile.tab.chat': 'চ্যাট',
  'mobile.tab.settings': 'সেটিংস',
  'mobileHome.greeting.morning': 'সুপ্রভাত',
  'mobileHome.greeting.afternoon': 'শুভ অপরাহ্ন',
  'mobileHome.greeting.evening': 'শুভ সন্ধ্যা',
  'mobileHome.themeToggle': 'ডার্ক মোড টগল করুন',
  'mobileHome.status.title': 'আপনার ডেস্কটপ',
  'mobileHome.status.checking': 'যাচাই করা হচ্ছে…',
  'mobileHome.status.online': 'সংযুক্ত',
  'mobileHome.status.offline': 'নাগালের বাইরে',
  'mobileHome.status.manage': 'পরিচালনা',
  'mobileHome.transport.lan': 'লোকাল নেটওয়ার্ক',
  'mobileHome.transport.tunnel': 'নিরাপদ টানেল',
  'mobileHome.transport.cloud': 'ক্লাউড রিলে',
  'mobileHome.cta.title': 'আপনার AI-এর সাথে কথা বলুন',
  'mobileHome.cta.subtitle': 'কথা বলতে চেপে ধরুন, বা টাইপ করুন. আপনার সুবিধা, এক ট্যাপ দূরে.',
  'mobileHome.suggestions.title': 'জিজ্ঞাসা করে দেখুন',
  ...
  'mobileWelcome.hint':
    'আপনার ডেস্কটপ ও ক্লাউড এজেন্টে সংযোগ করতে লগ ইন করুন, অথবা আপনার কম্পিউটারে CloserEdge AI থেকে QR কোড স্ক্যান করুন.',
  'mobileLogin.title': 'লগ ইন',
  'mobileLogin.pickDesktop': 'একটি ডেস্কটপ বেছে নিন',
  'mobileLogin.email': 'ইমেল',
  'mobileLogin.password': 'পাসওয়ার্ড',
  'mobileLogin.signingIn': 'সাইন ইন করা হচ্ছে…',
  'mobileLogin.loadingDesktops': 'আপনার ডেস্কটপ খোঁজা হচ্ছে…',
  'mobileLogin.noDesktops':
    'আপনার অ্যাকাউন্টে এখনও কোনো ডেস্কটপ পাওয়া যায়নি. আপনার কম্পিউটারে CloserEdge AI খুলুন এবং সেটিংস → ডিভাইস-এ ক্লাউড পেয়ারিং চালু করুন.',
  'mobileLogin.useQrInstead': 'পরিবর্তে QR কোড দিয়ে পেয়ার করুন',
  'mobileLogin.desktopOnline': 'সংযোগের জন্য প্রস্তুত',
  'mobileLogin.desktopOffline': 'অফলাইন — এই কম্পিউটারে CloserEdge খুলুন',
  'mobileLogin.connecting': '{label}-এ সংযোগ করা হচ্ছে…',
  'mobileLogin.error.expired':
    'এই ডেস্কটপটি সম্প্রতি রিফ্রেশ হয়নি — নিশ্চিত করুন CloserEdge AI চালু আছে, তারপর আবার চেষ্টা করুন.',
  'mobileLogin.error.unreachable': 'সেই ডেস্কটপে পৌঁছানো যায়নি. এটি কি অনলাইনে আছে?',
  'devices.cloudPairing.title': 'ক্লাউড পেয়ারিং',
  'devices.cloudPairing.body':
    'আপনার CloserEdge অ্যাকাউন্টে সাইন ইন করা ফোনগুলোকে QR কোড স্ক্যান ছাড়াই সংযোগ করতে দিন.',
