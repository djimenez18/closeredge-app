...
const messages: TranslationMap = {
  ...
  'rewards.localUnavailable':
    'La connexion locale ne permet pas de gagner des récompenses, des coupons ou du crédit de parrainage. Déconnecte-toi puis connecte-toi avec un compte CloserEdge AI si tu veux que les récompenses comptent.',
  ...
  'mobile.tab.home': 'Accueil',
  'mobile.tab.chat': 'Chat',
  'mobile.tab.settings': 'Paramètres',
  'mobileHome.greeting.morning': 'Bonjour',
  'mobileHome.greeting.afternoon': 'Bon après-midi',
  'mobileHome.greeting.evening': 'Bonsoir',
  'mobileHome.themeToggle': 'Basculer le mode sombre',
  'mobileHome.status.title': 'Votre ordinateur',
  'mobileHome.status.checking': 'Vérification…',
  'mobileHome.status.online': 'Connecté',
  'mobileHome.status.offline': 'Injoignable',
  'mobileHome.status.manage': 'Gérer',
  'mobileHome.transport.lan': 'Réseau local',
  'mobileHome.transport.tunnel': 'Tunnel sécurisé',
  'mobileHome.transport.cloud': 'Relais cloud',
  'mobileHome.cta.title': 'Parlez à votre IA',
  'mobileHome.cta.subtitle':
    'Maintenez pour parler, ou écrivez. Votre avantage, à portée de doigt.',
  'mobileHome.suggestions.title': 'Essayez de demander',
  'mobileHome.suggestion.listing': "Rédiger la description d'une annonce",
  'mobileHome.suggestion.followup': 'Écrire un message de suivi client',
  'mobileHome.suggestion.plan': 'Planifier ma journée',
  'mobileDevices.subtitle': 'Ordinateurs associés à ce téléphone.',
  'mobileDevices.pairAnother': 'Associer un autre appareil',
  'mobileDevices.empty': 'Aucun ordinateur associé pour le moment.',
  'mobileWelcome.tagline': 'Votre employé IA, dans votre poche.',
  'mobileWelcome.logIn': 'Se connecter',
  'mobileWelcome.scanQr': 'Associer avec un code QR',
  'mobileWelcome.hint':
    'Connectez-vous pour accéder à vos ordinateurs et agents cloud, ou scannez le code QR depuis CloserEdge AI sur votre ordinateur.',
  'mobileLogin.title': 'Se connecter',
  'mobileLogin.pickDesktop': 'Choisir un ordinateur',
  'mobileLogin.email': 'E-mail',
  'mobileLogin.password': 'Mot de passe',
  'mobileLogin.signingIn': 'Connexion…',
  'mobileLogin.loadingDesktops': 'Recherche de vos ordinateurs…',
  'mobileLogin.noDesktops':
    "Aucun ordinateur trouvé sur votre compte pour l'instant. Ouvrez CloserEdge AI sur votre ordinateur et activez l'association cloud dans Paramètres → Appareils.",
  'mobileLogin.useQrInstead': 'Associer plutôt avec un code QR',
  'mobileLogin.desktopOnline': 'Prêt à se connecter',
  'mobileLogin.desktopOffline': 'Hors ligne — ouvrez CloserEdge sur cet ordinateur',
  'mobileLogin.connecting': 'Connexion à {label}…',
  'mobileLogin.error.expired':
    "Cet ordinateur ne s'est pas actualisé récemment — assurez-vous que CloserEdge AI est en cours d'exécution, puis réessayez.",
  'mobileLogin.error.unreachable': 'Impossible de joindre cet ordinateur. Est-il en ligne ?',
  'devices.cloudPairing.title': 'Association cloud',
  'devices.cloudPairing.body':
    'Permettez aux téléphones connectés à votre compte CloserEdge de se connecter sans scanner de code QR.',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Binaire CloserEdge AI introuvable. Si vous exécutez à partir des sources, compilez avec : cargo build --bin openhuman-core',
