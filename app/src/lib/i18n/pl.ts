...
const messages: TranslationMap = {
  ...
  'welcome.title': 'Witaj w CloserEdge AI',
  ...
  'welcome.resetErrorFallback':
    'Nie udało się wyczyścić danych aplikacji. Zamknij i ponownie otwórz CloserEdge AI, a następnie spróbuj ponownie.',
  ...
  'home.statusCoreUnreachable':
    'Rdzeń CloserEdge AI nie odpowiada. Proces w tle mógł ulec awarii lub nie uruchomić się.',
  ...
  'rewards.localUnavailable':
    'Logowanie lokalne nie zbiera nagród, voucherów ani środków z poleceń. Wyloguj się i zaloguj kontem CloserEdge AI, jeśli zależy Ci na nagrodach.',
  ...
  'onboarding.welcome': 'Cześć. Jestem CloserEdge AI.',
  ...
  'onboarding.finishDesc': 'Gotowe! Zacznij korzystać z CloserEdge AI.',
  'onboarding.skip': 'Pomiń',
  'onboarding.getStarted': 'Rozpocznij',
  'onboarding.runtimeChoice.title': 'Jak chcesz uruchomić CloserEdge AI?',
  'onboarding.runtimeChoice.subtitle':
    'Wybierz, jak dużą część CloserEdge AI ma obsłużyć za Ciebie. Możesz to zmienić później w Ustawieniach.',
  'onboarding.runtimeChoice.cloud.title': 'Prosto',
  'onboarding.runtimeChoice.cloud.tagline':
    'Korzystaj z logowania CloserEdge AI, routingu modeli, wyszukiwarki i zarządzanych integracji.',
  ...
  'onboarding.runtimeChoice.custom.tagline':
    'Przynieś własne klucze. Wybierz, które usługi CloserEdge AI ma wywoływać.',
  ...
  'onboarding.custom.defaultSubtitle': 'Niech CloserEdge AI zarządza tym za Ciebie.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'CloserEdge AI domyślnie kieruje obciążenia przez zarządzany backend. Bez kluczy, bez konfiguracji.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'CloserEdge AI dostarcza zarządzanych dostawców STT/TTS, którzy mogą wysyłać audio/tekst do usług hostowanych.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'CloserEdge AI pośredniczy w OAuth i wywołaniach narzędzi przez zarządzaną przestrzeń Composio.',
  ...
  'onboarding.custom.search.subtitle': 'Jak CloserEdge AI wyszukuje w sieci w Twoim imieniu.',
  'onboarding.custom.search.defaultDesc':
    'CloserEdge AI domyślnie używa zarządzanego proxy wyszukiwarki. Klucz API niepotrzebny.',
  'onboarding.custom.search.configureDesc':
    'Przynieś własny klucz dostawcy (Tavily, Brave itp.). Skonfiguruj w Ustawieniach › Narzędzia.',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'Jak CloserEdge AI generuje wektory embeddings na potrzeby wyszukiwania semantycznego.',
  'onboarding.custom.embeddings.defaultDesc':
    'CloserEdge AI używa zarządzanej usługi embeddings. Klucz API niepotrzebny.',
  ...
  'onboarding.custom.memory.subtitle':
    'Jak CloserEdge AI zapamiętuje Twój kontekst, preferencje i wcześniejsze rozmowy.',
  'onboarding.custom.memory.defaultDesc':
    'CloserEdge AI zarządza pamięcią automatycznie. Nic do skonfigurowania.',
  ...
  'misc.beta':
    'CloserEdge AI jest we wczesnej fazie beta. Chętnie poznamy Twoje uwagi — każdy zgłoszony błąd pomaga nam szybciej wydać poprawki.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Pomóż ulepszać CloserEdge AI, udostępniając anonimowe raporty awarii i analitykę użytkowania. Wszystkie dane są w pełni anonimowe — nigdy nie zbieramy danych osobowych, wiadomości, kluczy portfela ani informacji o sesji.',
  ...
  'privacy.autoHandoffMeetDesc':
    'Gdy spotkanie Google Meet się kończy, orchestrator CloserEdge AI może odczytać transkrypcję i wykonać akcje, np. przygotować wiadomości, zaplanować działania lub opublikować podsumowanie w podłączonym workspace Slack. Domyślnie wyłączone.',
  ...
  'settings.search.menuDesc':
    'Użyj domyślnie wyszukiwarki zarządzanej przez CloserEdge AI lub podłącz własnego dostawcę z kluczem API.',
  'settings.search.description':
    'Wybierz wyszukiwarkę używaną przez agenta. Zarządzana korzysta z backendu CloserEdge AI (bez konfiguracji). Parallel i Brave działają bezpośrednio z Twojego urządzenia, używając Twojego klucza API.',
  ...
  'settings.search.engineManagedLabel': 'CloserEdge AI zarządzane',
  'settings.search.engineManagedDesc': 'Domyślnie. Przez backend CloserEdge AI — bez klucza API.',
  'settings.search.localManagedUnavailable':
    'Wyszukiwarka zarządzana przez CloserEdge AI jest niedostępna dla użytkowników lokalnych. Dodaj własny klucz API Parallel lub Brave, aby włączyć wyszukiwanie w sieci.',
  ...
  'devices.betaText':
    'Ta funkcja jest obecnie w fazie beta. Sparuj iPhone z tą instalacją CloserEdge AI, aby używać go jako zdalnego klienta.',
  ...
  'devices.emptyState':
    'Zeskanuj kod QR w aplikacji iPhone, aby połączyć go z tą sesją CloserEdge AI.',
  ...
  'devices.pairModal.instructions': 'Otwórz aplikację CloserEdge AI na iPhone i zeskanuj ten kod.',
  ...
  'mobileHome.greeting.morning': 'Dzień dobry',
  'mobileHome.greeting.afternoon': 'Miłego popołudnia',
  'mobileHome.greeting.evening': 'Dobry wieczór',
  'mobileHome.themeToggle': 'Przełącz tryb ciemny',
  'mobileHome.status.title': 'Twój komputer',
  'mobileHome.status.checking': 'Sprawdzanie…',
  'mobileHome.status.online': 'Połączono',
  'mobileHome.status.offline': 'Nieosiągalny',
  'mobileHome.status.manage': 'Zarządzaj',
  'mobileHome.transport.lan': 'Sieć lokalna',
  'mobileHome.transport.tunnel': 'Bezpieczny tunel',
  'mobileHome.transport.cloud': 'Przekaźnik w chmurze',
  'mobileHome.cta.title': 'Porozmawiaj ze swoją AI',
  'mobileHome.cta.subtitle':
    'Przytrzymaj, aby mówić, lub pisz. Twoja przewaga, o jedno dotknięcie.',
  'mobileHome.suggestions.title': 'Spróbuj zapytać',
  'mobileHome.suggestion.listing': 'Napisz opis oferty',
  'mobileHome.suggestion.followup': 'Napisz wiadomość do klienta',
  'mobileHome.suggestion.plan': 'Zaplanuj mój dzień',
  'mobileDevices.subtitle': 'Komputery sparowane z tym telefonem.',
  'mobileDevices.pairAnother': 'Sparuj inne urządzenie',
  'mobileDevices.empty': 'Brak sparowanych komputerów.',
  'mobileWelcome.tagline': 'Twój pracownik AI, w Twojej kieszeni.',
  'mobileWelcome.logIn': 'Zaloguj się',
  'mobileWelcome.scanQr': 'Sparuj kodem QR',
  'mobileWelcome.hint':
    'Zaloguj się, aby połączyć się z komputerami i agentami w chmurze, lub zeskanuj kod QR z CloserEdge AI na swoim komputerze.',
  'mobileLogin.title': 'Zaloguj się',
  'mobileLogin.pickDesktop': 'Wybierz komputer',
  'mobileLogin.email': 'E-mail',
  'mobileLogin.password': 'Hasło',
  'mobileLogin.signingIn': 'Logowanie…',
  'mobileLogin.loadingDesktops': 'Szukanie Twoich komputerów…',
  'mobileLogin.noDesktops':
    'Nie znaleziono jeszcze żadnych komputerów na Twoim koncie. Otwórz CloserEdge AI na komputerze i włącz Parowanie w chmurze w Ustawienia → Urządzenia.',
  'mobileLogin.useQrInstead': 'Zamiast tego sparuj kodem QR',
  'mobileLogin.desktopOnline': 'Gotowy do połączenia',
  'mobileLogin.desktopOffline': 'Offline — otwórz CloserEdge na tym komputerze',
  'mobileLogin.connecting': 'Łączenie z {label}…',
  'mobileLogin.error.expired':
    'Ten komputer nie odświeżył się ostatnio — upewnij się, że CloserEdge AI działa, a następnie spróbuj ponownie.',
  'mobileLogin.error.unreachable': 'Nie można połączyć się z tym komputerem. Czy jest online?',
  'devices.cloudPairing.title': 'Parowanie w chmurze',
  'devices.cloudPairing.body':
    'Pozwól telefonom zalogowanym na Twoje konto CloserEdge łączyć się bez skanowania kodu QR.',
  ...
  'autonomy.maxActionsHelp':
    'Maksymalna liczba akcji narzędzi, którą agent może uruchomić w ciągu kolejnej godziny. Nowa wartość obowiązuje od następnego czatu. Zadania cron i nasłuchy kanałów zachowują dotychczasowy limit do restartu CloserEdge AI.',
  ...
  'settings.tools.chooseCapabilities':
    'Wybierz, z jakich możliwości CloserEdge AI może korzystać w Twoim imieniu.',
  ...
  'voice.providers.chip.cloud': 'CloserEdge AI (zarządzany)',
  'voice.providers.chip.cloudAria': 'Zarządzany dostawca CloserEdge AI jest zawsze włączony',
  ...
  'backend.cloudDescription':
    'Szybkie, mocne modele kierowane przez backend CloserEdge AI. Gotowe do użycia od razu.',
  'backend.privacyNote':
  ...
  'bootCheck.desktopDescription':
    'CloserEdge AI potrzebuje środowiska do działania. Wybierz, gdzie ma się znajdować.',
  'bootCheck.webDescription':
    'W przeglądarce CloserEdge AI łączy się ze środowiskiem, którym zarządzasz. Wpisz jego URL i token poniżej lub pobierz aplikację desktopową, aby uruchomić środowisko bezpośrednio na komputerze.',
  ...
  'bootCheck.legacyDescription':
    'Osobno zainstalowany daemon CloserEdge AI już działa na tym urządzeniu. Musimy go usunąć, zanim wbudowane środowisko przejmie kontrolę.',
  ...
  'bootCheck.portConflictBody':
    'Inny proces używa portu sieciowego potrzebnego CloserEdge AIowi. Spróbujemy to naprawić automatycznie.',
  ...
  'composio.expiredDescription':
    'Połącz ponownie, aby ponownie włączyć narzędzia {name}. CloserEdge AI utrzyma tę integrację jako niedostępną, dopóki nie odświeżysz dostępu OAuth.',
  ...
  'app.connectionIndicator.connected': 'Połączono z CloserEdge AI 🚀',
  ...
  'app.openhumanLink.notifications.blockedStep2': 'Znajdź CloserEdge AI na liście aplikacji.',
  ...
  'app.openhumanLink.notifications.sent':
    'Wysłano powiadomienie testowe. Jeśli go nie otrzymałeś(aś), przejdź do Ustawienia systemowe → Powiadomienia → CloserEdge AI, włącz „Zezwalaj na powiadomienia” i ustaw styl banera na „Trwały”.',
  ...
  'app.routeLoading.initializing': 'Inicjalizacja CloserEdge AI...',
  ...
  'channels.authMode.managed_dm': 'Zaloguj się z CloserEdge AI',
  ...
  'channels.discord.authMode.oauth.description':
    'Zainstaluj bota CloserEdge AI na swoim serwerze Discord przez OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Powiąż swoje osobiste konto Discord z botem CloserEdge AI.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Pisz bezpośrednio do bota CloserEdge AI na Telegramie.',
  ...
  'iosPair.error.invalidQr':
    'Nieprawidłowy kod QR. Upewnij się, że skanujesz kod parowania CloserEdge AI.',
  ...
  'iosPair.instructions':
    'Otwórz CloserEdge AI na komputerze, przejdź do Ustawienia > Urządzenia i kliknij „Sparuj telefon”, aby pokazać kod QR.',
  'iosPair.retryScan': 'Skanuj ponownie',
  'iosPair.scanQrCode': 'Zeskanuj kod QR',
  'iosPair.scannerOpening': 'Otwieranie skanera...',
  'iosPair.step.openDesktop': 'Otwórz CloserEdge AI na komputerze',
  ...
  'composio.connect.permissionsNoteSuffix':
    'uprawnienia agenta CloserEdge AI są kontrolowane poniżej przełącznikami odczytu, zapisu i administracji.',
  ...
  'daemon.serviceBlockingGate.body':
    'Rdzeń CloserEdge AI nie odpowiada. Spróbuj ponownie lub pobierz najnowszą wersję aplikacji.',
  ...
  'home.banners.promoCreditsBody': 'Przetestuj CloserEdge AI, a gdy będziesz gotowy(a) na więcej,',
  ...
  'intelligence.diagram.imageAlt': 'Najnowszy wygenerowany diagram architektury CloserEdge AI',
  ...
  'overlay.ariaOrb': 'Nakładka CloserEdge AI',
  ...
  'pages.settings.features.toolsDesc': 'Wybierz, z jakich możliwości CloserEdge AI może korzystać',
  ...
  'rewards.referralSection.subtitle':
    'Zaproś znajomych do CloserEdge AI i zarabiajcie kredyty razem.',
  ...
  'settings.ai.defaultResolvesTo': 'CloserEdge AI',
  ...
  'settings.ai.openhumanDefault': 'CloserEdge AI (domyślny)',
  ...
  'settings.ai.routing.managedDesc':
    'CloserEdge AI uruchomi całą inferencję w chmurze, wybierze najlepszy model dla zadania, zoptymalizuje koszty i zachowa najbezpieczniejsze domyślne ustawienia routingu.',
  'settings.ai.routing.managedMsg':
    'CloserEdge AI obsłuży całą inferencję dla każdego obciążenia i automatycznie wybierze najlepszą ścieżkę pod kątem kosztu, jakości i bezpieczeństwa.',
  ...
  'settings.composio.confirmWarning':
    'Twoje istniejące integracje (Gmail, Slack, GitHub itp. połączone przez CloserEdge AI) nie będą widoczne — żyją w tenant Composio zarządzanym przez CloserEdge AI.',
  ...
  'settings.composio.modeManaged': 'Zarządzany (CloserEdge AI robi to za Ciebie)',
  'settings.composio.modeManagedDesc':
    'CloserEdge AI pośredniczy w wywołaniach narzędzi przez nasz backend (zalecane). Uwierzytelnianie jest pośredniczone; nie musisz wklejać klucza API Composio. Webhooks są w pełni trasowane.',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'CloserEdge AI traktuje teraz Ollamę jako zewnętrzne środowisko inferencji. Uruchom własny serwer Ollama, pobierz potrzebne modele i skieruj na niego trasowanie workloadów.',
  ...
  'settings.developerMenu.tools.desc':
    'Włącz lub wyłącz możliwości, z których CloserEdge AI może korzystać w Twoim imieniu',
  ...
  'settings.developerMenu.mcpServer.desc':
    'Skonfiguruj zewnętrznych klientów MCP do połączenia z CloserEdge AIem',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Nie znaleziono pliku binarnego CloserEdge AI. Jeśli uruchamiasz ze źródeł, zbuduj: cargo build --bin openhuman-core',
  ...
  'settings.mascot.characterDesc': 'Wybierz charakter maskotki CloserEdge AI.',
  ...
  'settings.mascot.colorAria': 'Kolor CloserEdge AI',
  ...
  'settings.mascot.libraryUnavailable': 'Biblioteka CloserEdge AI niedostępna',
  'settings.mascot.title': 'CloserEdge AI',
  'settings.mascot.loadingLibrary': 'Wczytywanie biblioteki CloserEdge AI…',
  ...
  'settings.mascot.localDefault': 'Lokalny CloserEdge AI (domyślny)',
  'settings.mascot.menuTitle': 'Maskotka',
  'settings.mascot.menuDesc': 'Wybierz kolor maskotki używany w aplikacji',
  'settings.mascot.noCharacters': 'Nie ma jeszcze dostępnych postaci CloserEdge AI',
  ...
  'settings.memoryWindow.description':
    'Ile zapamiętanego kontekstu CloserEdge AI wstrzykuje do każdego nowego uruchomienia agenta. Większe okno daje większą świadomość poprzednich rozmów, ale używa więcej tokenów — i kosztuje więcej — przy każdym uruchomieniu.',
  ...
  'skills.meetingBots.bannerDesc':
    'Wklej link Google Meet, a CloserEdge AI dołączy jako gość, mówi, słucha i odpowiada.',
  'skills.meetingBots.bannerTitle': 'Wyślij CloserEdge AI na spotkanie',
  'skills.meetingBots.busyTitle': 'CloserEdge AI jest zajęty',
  'skills.meetingBots.comingSoon': 'Wkrótce',
  'skills.meetingBots.couldNotStartTitle': 'Nie udało się uruchomić CloserEdge AI',
  'skills.meetingBots.displayName': 'Wyświetlana nazwa',
  'skills.meetingBots.failedToStart': 'Nie udało się uruchomić CloserEdge AI.',
  'skills.meetingBots.joiningMessage': 'Powinien pojawić się jako uczestnik w ciągu kilku sekund.',
  'skills.meetingBots.joiningTitle': 'CloserEdge AI dołącza do spotkania',
  'skills.meetingBots.meetingLink': 'Link spotkania',
  'skills.meetingBots.modalAriaLabel': 'Wyślij CloserEdge AI na spotkanie',
  'skills.meetingBots.modalDesc':
    'CloserEdge AI dołącza jako anonimowy gość, transmituje wideo do rozmowy i odpowiada przez agenta.',
  'skills.meetingBots.modalTitle': 'Wyślij CloserEdge AI na spotkanie',
  ...
  'settings.mascot.noCharactersAvailable': 'Nie ma jeszcze dostępnych postaci CloserEdge AI',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'Zarządzaj procesem Ollama i pobraniami modeli poza CloserEdge AIem, a następnie uruchom ponownie diagnostykę.',
  ...
  'keyring.consent.description':
    'Pęk kluczy systemu operacyjnego jest niedostępny. CloserEdge AI potrzebuje Twojej zgody na przechowywanie sekretów w lokalnym zaszyfrowanym magazynie.',
