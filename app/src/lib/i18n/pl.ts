...
const messages: TranslationMap = {
  ...
  'home.statusBrowserMode':
    'Uruchomiono w trybie podgladu przegladarki. Zainstaluj aplikacje desktopowa, aby uzyskac pelne doswiadczenie.',
  ...
  'app.connectionIndicator.browserMode': 'Tryb przegladarki',
  ...
  'settings.localModel.download.summaryHelper':
    'Wywołuje `closeredge.inference_summarize` przez rdzeń Rust',
  ...
  'settings.mcpServer.toolsSectionDesc':
    'Narzędzia udostępniane przez serwer stdio MCP podczas uruchamiania closeredge-core mcp',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Nie znaleziono pliku binarnego CloserEdge AI. Jeśli uruchamiasz ze źródeł, zbuduj: cargo build --bin closeredge-core',
  ...
  'skills.create.scopeUserHint':
    'Zapisane do ~/.closeredge/skills/<slug>/SKILL.md — dostępne we wszystkich przestrzeniach roboczych.',
  ...
  'skills.install.errors.writeFailedHint':
    'Katalog umiejętności w przestrzeni roboczej nie był zapisywalny. Sprawdź uprawnienia systemu plików dla `<workspace>/.closeredge/skills/`.',
