...
const messages: TranslationMap = {
  ...
  'welcome.title': 'Bem-vindo ao CloserEdge AI',
  'welcome.subtitle':
  ...
  'welcome.resetErrorFallback':
    'Não foi possível limpar os dados do app. Por favor, feche e reabra o CloserEdge AI e tente novamente.',
  ...
  'home.statusCoreUnreachable':
    'O processo em segundo plano do CloserEdge AI não está respondendo. Ele pode ter travado ou falhado ao iniciar.',
  'home.statusInternetOffline':
    'Seu dispositivo está offline agora. Verifique sua rede ou reinicie o app para reconectar.',
  'home.statusBrowserMode':
    'Executando no modo de visualizacao do navegador. Instale o app desktop para a experiencia completa.',
  ...
  'onboarding.welcome': 'Olá. Eu sou o CloserEdge AI.',
  ...
  'onboarding.finishDesc': 'Tudo pronto! Comece a usar o CloserEdge AI.',
  'onboarding.skip': 'Pular',
  'onboarding.getStarted': 'Começar',
  'onboarding.runtimeChoice.title': 'Como você gostaria de rodar o CloserEdge AI?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Deixe o CloserEdge AI gerenciar tudo para você.',
  ...
  'onboarding.custom.defaultSubtitle': 'Deixe o CloserEdge AI gerenciar para você.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'O CloserEdge AI direciona cada carga de trabalho para um modelo padrão adequado. Sem chaves, sem configuração.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'O CloserEdge AI vem com STT/TTS gerenciado que funciona sem configuração.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'O CloserEdge AI usa um espaço de trabalho Composio gerenciado. Um clique para conectar cada serviço depois.',
  ...
  'onboarding.custom.search.subtitle': 'Como o CloserEdge AI pesquisa na web em seu nome.',
  'onboarding.custom.search.defaultDesc':
    'O CloserEdge AI usa um backend de pesquisa gerenciado. Sem chaves necessárias.',
  ...
  'onboarding.custom.embeddings.subtitle':
    'Como o CloserEdge AI gera embeddings vetoriais para busca semântica na memória.',
  'onboarding.custom.embeddings.defaultDesc':
    'O CloserEdge AI usa um serviço gerenciado de embeddings. Nenhuma chave de API necessária.',
  ...
  'onboarding.custom.memory.subtitle':
    'Como o CloserEdge AI se lembra do seu contexto, preferências e conversas anteriores.',
  'onboarding.custom.memory.defaultDesc':
    'O CloserEdge AI gerencia o armazenamento e a recuperação de memória automaticamente. Sem nada para configurar.',
  ...
  'invites.statusExpired': 'Status expirado',
  ...
  'misc.beta':
    'O CloserEdge AI está em beta inicial. Sinta-se à vontade para compartilhar feedback ou reportar bugs que encontrar — cada relato nos ajuda a melhorar mais rápido.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Ajude a melhorar o CloserEdge AI compartilhando relatórios de falhas e análises de uso anônimas. Todos os dados são totalmente anonimizados — nenhum dado pessoal, mensagem, chave de carteira ou informação de sessão é coletado.',
  ...
  'privacy.autoHandoffMeetDesc':
    'Quando uma chamada do Google Meet termina, o orquestrador do CloserEdge AI pode ler a transcrição e pode realizar ações como redigir mensagens, agendar acompanhamentos ou postar resumos no seu espaço de trabalho Slack conectado. Desativado por padrão.',
  ...
  'settings.search.menuDesc':
    'Padrão para pesquisa gerenciada por CloserEdge AI ou conecte seu próprio provedor com uma chave API.',
  'settings.search.description':
    'Escolha o mecanismo de busca usado pelo agente, ou desative as ferramentas de pesquisa completamente. Gerenciado usa o backend do CloserEdge AI (sem configuração). Parallel, Brave e Querit funcionam diretamente do seu computador usando sua chave de API.',
  ...
  'settings.search.engineManagedLabel': 'CloserEdge AI Gerenciado',
  'settings.search.engineManagedDesc':
    'Padrão. Roteado através do backend CloserEdge AI — nenhuma chave API é necessária.',
  'settings.search.localManagedUnavailable':
    'A busca gerenciada pela CloserEdge AI não está disponível para usuários locais. Adicione sua própria chave de API do Parallel ou Brave para habilitar a busca na web.',
  ...
  'devices.betaText':
    'Este recurso está atualmente em beta. Vincule iPhones a este CloserEdge AI para usá-los como cliente remoto.',
  ...
  'devices.emptyState':
    'Escaneie um QR code no seu iPhone para conectá-lo a esta sessão do CloserEdge AI.',
  ...
  'devices.pairModal.instructions':
    'Abra o app CloserEdge AI no seu iPhone e escaneie este código.',
  ...
  'autonomy.maxActionsHelp':
    'Número máximo de ações de ferramentas que um agente pode executar por hora corrida. O novo valor se aplica ao próximo chat. Cron jobs e ouvintes de canais mantêm o limite atual até você reiniciar o CloserEdge AI.',
  ...
  'settings.tools.chooseCapabilities':
    'Escolha quais funcionalidades o CloserEdge AI pode usar em seu nome.',
  ...
  'voice.providers.chip.cloud': 'CloserEdge AI (Gerenciado)',
  'voice.providers.chip.cloudAria': 'O provedor gerenciado CloserEdge AI está sempre ativado',
  ...
  'bootCheck.desktopDescription':
    'O CloserEdge AI precisa de um runtime para pensar. Escolha onde ele deve ficar.',
  'bootCheck.webDescription':
    'Na web, o CloserEdge AI conecta-se a um runtime que você controla. Insira o URL e o token de autenticação abaixo, ou baixe o app desktop para rodar um na sua máquina.',
  ...
  'bootCheck.legacyDescription':
    'Um daemon CloserEdge AI instalado separadamente já está rodando neste dispositivo. Precisamos removê-lo antes que o runtime integrado possa assumir.',
  ...
  'bootCheck.portConflictBody':
    'Outro processo está usando a porta de rede que o CloserEdge AI precisa. Tentaremos corrigir isso automaticamente.',
  ...
  'composio.expiredDescription':
    'Reconecte para reativar as ferramentas {name}. CloserEdge AI manterá esta integração indisponível até que você atualize o acesso de OAuth.',
  ...
  'app.connectionIndicator.connected': 'Conectado ao CloserEdge AI 🚀',
  ...
  'app.openhumanLink.notifications.sent':
    'Notificação de teste enviada. Se você não a recebeu, vá em Configurações do Sistema → Notificações → CloserEdge AI, ative Permitir Notificações e defina o Estilo de Banner como Persistente.',
  ...
  'channels.authMode.managed_dm': 'Faça login com CloserEdge AI',
  ...
  'channels.discord.authMode.oauth.description':
    'Instale o bot CloserEdge AI em seu servidor Discord via OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Vincule sua conta pessoal Discord ao bot CloserEdge AI.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Envie uma mensagem diretamente para o bot CloserEdge AI Telegram.',
  ...
  'iosPair.error.invalidQr':
    'QR code inválido. Certifique-se de estar escaneando um código de pareamento do CloserEdge AI.',
  ...
  'iosPair.instructions':
    'Abra o CloserEdge AI no seu desktop, vá em Configurações > Dispositivos e toque em "Parear telefone" para exibir o QR code.',
  'iosPair.retryScan': 'Repetir verificação',
  'iosPair.scanQrCode': 'Digitalizar QR code',
  'iosPair.scannerOpening': 'Scanner abrindo...',
  'iosPair.step.openDesktop': 'Abra CloserEdge AI na área de trabalho',
  ...
  'composio.connect.permissionsNoteSuffix':
    'As permissões do agente do CloserEdge AI são controladas abaixo como botões de leitura, escrita e admin.',
  ...
  'daemon.serviceBlockingGate.title': 'O core do CloserEdge AI está indisponível',
  'home.banners.communitySubtitle':
    'Receba suporte, compartilhe feedback e conecte-se com outros usuários.',
  'home.banners.communityTitle': 'Junte-se à nossa comunidade',
  ...
  'intelligence.diagram.imageAlt': 'Último diagrama de arquitetura CloserEdge AI gerado',
  ...
  'overlay.ariaOrb': 'Orb do CloserEdge AI',
  ...
  'settings.ai.openhumanDefault': 'CloserEdge AI (padrão)',
  ...
  'settings.ai.routing.managedDesc':
    'CloserEdge AI executará toda a inferência na nuvem, escolherá o melhor modelo para a tarefa, otimizará os custos e manterá os padrões de roteamento mais seguros.',
  'settings.ai.routing.managedMsg':
    'CloserEdge AI irá gerenciar toda a inferência para cada carga de trabalho e escolherá automaticamente a melhor rota em termos de custo, qualidade e segurança.',
  ...
  'settings.composio.confirmWarning':
    'Suas integrações existentes (Gmail, Slack, GitHub, etc. conectadas via CloserEdge AI) não ficarão visíveis — elas vivem no tenant do Composio gerenciado pelo CloserEdge AI.',
  ...
  'settings.composio.modeManaged': 'Gerenciado (CloserEdge AI cuida para você)',
  'settings.composio.modeManagedDesc':
    'O CloserEdge AI faz proxy das chamadas de ferramentas pelo nosso backend (recomendado). A autenticação é intermediada; você nunca cola uma chave de API do Composio. Webhooks são totalmente roteados.',
  ...
  'settings.localModel.download.summaryHelper':
    'Chamadas `closeredge.inference_summarize` via Rust core',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'O CloserEdge AI agora trata o Ollama como um runtime de inferência externo. Inicie seu próprio servidor Ollama, baixe os modelos desejados e aponte o roteamento de carga para ele.',
  ...
  'settings.developerMenu.tools.desc':
    'Ative ou desative capacidades que o CloserEdge AI pode usar em seu nome',
  ...
  'settings.developerMenu.mcpServer.desc':
    'Configurar clientes MCP externos para se conectarem a CloserEdge AI',
  ...
  'settings.mcpServer.toolsSectionDesc':
    'Ferramentas expostas por meio do servidor MCP stdio ao executar closeredge-core mcp',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'CloserEdge AI binário não encontrado. Se estiver executando a partir do código-fonte, crie com: cargo build --bin closeredge-core',
  ...
  'settings.memoryWindow.description':
    'Quanto contexto lembrado o CloserEdge AI injeta em cada nova execução do agente. Janelas maiores parecem mais cientes de conversas passadas, mas usam mais tokens — e custam mais — a cada execução.',
  ...
  'skills.create.scopeUserHint':
    'Escrito em ~/.closeredge/skills/<slug>/SKILL.md — disponível em todos os espaços de trabalho.',
  ...
  'skills.install.errors.writeFailedHint':
    'O diretório de habilidades do espaço de trabalho não era gravável. Verifique as permissões do sistema de arquivos para `<workspace>/.closeredge/skills/`.',
  ...
  'skills.meetingBots.couldNotStartTitle': 'Não foi possível iniciar o CloserEdge AI',
  'skills.meetingBots.displayName': 'Nome de exibição',
  'skills.meetingBots.failedToStart': 'Falha ao iniciar o CloserEdge AI.',
  'skills.meetingBots.joiningMessage': 'Ele deve aparecer como participante em alguns segundos.',
  'skills.meetingBots.joiningTitle': 'CloserEdge AI está entrando na reunião',
  'skills.meetingBots.meetingLink': 'Link da reunião',
  'skills.meetingBots.modalAriaLabel': 'Enviar CloserEdge AI para uma reunião',
  'skills.meetingBots.modalDesc': 'Descrição do modal',
  'skills.meetingBots.modalTitle': 'Enviar CloserEdge AI para uma reunião',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'Gerencie o processo do Ollama e o download de modelos fora do CloserEdge AI e, em seguida, execute o diagnóstico novamente.',
  ...
  'devOptions.menuToolsDesc':
    'Habilitar ou desabilitar recursos que CloserEdge AI pode usar em seu nome',
  ...
  'keyring.consent.description':
    'O chaveiro do sistema operacional não está acessível. O CloserEdge AI precisa da sua permissão para armazenar segredos usando armazenamento local criptografado.',
  ...
  'mobile.tab.chat': 'Bate-papo',
  'mobile.tab.settings': 'Configurações',
  'mobileHome.greeting.morning': 'Bom dia',
  'mobileHome.greeting.afternoon': 'Boa tarde',
  'mobileHome.greeting.evening': 'Boa noite',
  'mobileHome.themeToggle': 'Alternar modo escuro',
  'mobileHome.status.title': 'Seu desktop',
  'mobileHome.status.checking': 'Verificando…',
  'mobileHome.status.online': 'Conectado',
  'mobileHome.status.offline': 'Inacessível',
  'mobileHome.status.manage': 'Gerenciar',
  'mobileHome.transport.lan': 'Rede local',
  'mobileHome.transport.tunnel': 'Túnel seguro',
  'mobileHome.transport.cloud': 'Retransmissão na nuvem',
  'mobileHome.cta.title': 'Fale com sua IA',
  'mobileHome.cta.subtitle': 'Segure para falar ou digite. Sua vantagem, a um toque.',
  'mobileHome.suggestions.title': 'Experimente perguntar',
  'mobileHome.suggestion.listing': 'Redigir a descrição de um imóvel',
  'mobileHome.suggestion.followup': 'Escrever um acompanhamento para o cliente',
  'mobileHome.suggestion.plan': 'Planejar meu dia',
  'mobileDevices.subtitle': 'Desktops pareados com este telefone.',
  'mobileDevices.pairAnother': 'Parear outro dispositivo',
  'mobileDevices.empty': 'Nenhum desktop pareado ainda.',
  'mobileWelcome.tagline': 'Seu funcionário de IA, no seu bolso.',
  'mobileWelcome.logIn': 'Entrar',
  'mobileWelcome.scanQr': 'Parear com código QR',
  'mobileWelcome.hint':
    'Entre para se conectar aos seus desktops e agentes na nuvem, ou escaneie o código QR do CloserEdge AI no seu computador.',
  'mobileLogin.title': 'Entrar',
  'mobileLogin.pickDesktop': 'Escolha um desktop',
  'mobileLogin.email': 'E-mail',
  'mobileLogin.password': 'Senha',
  'mobileLogin.signingIn': 'Entrando…',
  'mobileLogin.loadingDesktops': 'Procurando seus desktops…',
  'mobileLogin.noDesktops':
    'Nenhum desktop encontrado na sua conta ainda. Abra o CloserEdge AI no seu computador e ative o Pareamento na nuvem em Configurações → Dispositivos.',
  'mobileLogin.useQrInstead': 'Parear com código QR em vez disso',
  'mobileLogin.desktopOnline': 'Pronto para conectar',
  'mobileLogin.desktopOffline': 'Offline — abra o CloserEdge neste computador',
  'mobileLogin.connecting': 'Conectando a {label}…',
  'mobileLogin.error.expired':
    'Esse desktop não foi atualizado recentemente — verifique se o CloserEdge AI está em execução e tente novamente.',
  'mobileLogin.error.unreachable': 'Não foi possível alcançar esse desktop. Ele está online?',
  'devices.cloudPairing.title': 'Pareamento na nuvem',
  'devices.cloudPairing.body':
    'Permita que telefones conectados à sua conta CloserEdge se conectem sem escanear um código QR.',
