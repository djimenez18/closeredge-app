...
const messages: TranslationMap = {
  ...
  'rewards.localUnavailable':
    'O login local não rende recompensas, cupons nem crédito de indicação. Saia e continue entrando com uma conta CloserEdge AI se quiser que as recompensas contem.',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'CloserEdge AI binário não encontrado. Se estiver executando a partir do código-fonte, crie com: cargo build --bin openhuman-core',
  ...
  'settings.mascot.colorAria': 'CloserEdge AI cor',
  ...
  'settings.mascot.libraryUnavailable': 'CloserEdge AI biblioteca indisponível',
  'settings.mascot.title': 'CloserEdge AI',
  'settings.mascot.loadingLibrary': 'Carregando biblioteca do CloserEdge AI…',
  ...
  'settings.mascot.localDefault': 'CloserEdge AI local (padrão)',
  'settings.mascot.menuTitle': 'Mascote',
  'settings.mascot.menuDesc': 'Escolha a cor do mascote usada em todo o app',
  'settings.mascot.noCharacters': 'Nenhum personagem do CloserEdge AI disponível ainda',
  ...
  'settings.mascot.noCharactersAvailable': 'Nenhum personagem do CloserEdge AI disponível ainda',
