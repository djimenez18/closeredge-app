...
const messages: TranslationMap = {
  ...
  'welcome.title': 'CloserEdge AI में आपका स्वागत है',
  ...
  'welcome.resetErrorFallback':
    'ऐप डेटा साफ़ नहीं हो सका। CloserEdge AI बंद करें और दोबारा खोलें, फिर पुनः प्रयास करें।',
  ...
  'home.statusCoreUnreachable':
    'लोकल कोर साइडकार रिस्पॉन्ड नहीं कर रहा। CloserEdge AI का बैकग्राउंड प्रोसेस क्रैश हो गया होगा या शुरू नहीं हो पाया।',
  ...
  'rewards.localUnavailable':
    'लोकल लॉगिन पर rewards, coupons या referral credit नहीं मिलते। rewards पाने के लिए लॉग आउट करें और CloserEdge AI खाते से साइन इन करें।',
  ...
  'onboarding.welcome': 'नमस्ते। मैं CloserEdge AI हूँ।',
  ...
  'onboarding.finishDesc': 'सब तैयार है! CloserEdge AI इस्तेमाल शुरू करें।',
  'onboarding.skip': 'स्किप करें',
  'onboarding.getStarted': 'शुरू करें',
  'onboarding.runtimeChoice.title': 'CloserEdge AI कैसे चलाना चाहते हैं?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'CloserEdge AI सब कुछ मैनेज करेगा।',
  ...
  'onboarding.custom.defaultSubtitle': 'CloserEdge AI खुद मैनेज करेगा।',
  ...
  'onboarding.custom.inference.defaultDesc':
    'CloserEdge AI हर वर्कलोड के लिए खुद सही मॉडल चुनता है। कोई key नहीं, कोई सेटअप नहीं।',
  ...
  'onboarding.custom.voice.defaultDesc':
    'CloserEdge AI में मैनेज्ड STT/TTS है जो बस काम करता है। कुछ सेट नहीं करना।',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'CloserEdge AI मैनेज्ड Composio वर्कस्पेस चलाता है। हर सर्विस एक क्लिक में कनेक्ट होती है।',
  ...
  'onboarding.custom.search.subtitle': 'CloserEdge AI आपकी तरफ से वेब कैसे सर्च करता है।',
  'onboarding.custom.search.defaultDesc':
    'CloserEdge AI मैनेज्ड सर्च बैकएंड इस्तेमाल करता है। कोई key नहीं चाहिए।',
  'onboarding.custom.search.configureDesc':
    'अपनी सर्च प्रोवाइडर key लाएं (Tavily, Brave, आदि)। Settings › Tools में कॉन्फिगर करें।',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'CloserEdge AI सिमेंटिक मेमोरी खोज के लिए वेक्टर एम्बेडिंग कैसे बनाता है।',
  'onboarding.custom.embeddings.defaultDesc':
    'CloserEdge AI एक प्रबंधित एम्बेडिंग सेवा का उपयोग करता है। कोई API कुंजी आवश्यक नहीं।',
  ...
  'onboarding.custom.memory.subtitle':
    'CloserEdge AI आपका कॉन्टेक्स्ट, पसंद और पुरानी बातें कैसे याद रखता है।',
  'onboarding.custom.memory.defaultDesc':
    'CloserEdge AI मेमोरी स्टोरेज और रिट्रीवल अपने आप मैनेज करता है। कुछ सेट नहीं करना।',
  ...
  'misc.beta':
    'CloserEdge AI अभी अर्ली बीटा में है। फीडबैक शेयर करें या कोई बग मिले तो रिपोर्ट करें — हर रिपोर्ट हमें तेज़ी से काम करने में मदद करती है।',
  ...
  'privacy.shareAnonymizedDataDesc':
    'अनॉनिमस क्रैश रिपोर्ट और यूसेज एनालिटिक्स शेयर करके CloserEdge AI को बेहतर बनाने में मदद करें। सभी डेटा पूरी तरह अनॉनिमाइज़्ड है — कोई पर्सनल डेटा, मैसेज, वॉलेट keys या सेशन जानकारी कभी कलेक्ट नहीं होती।',
  ...
  'privacy.autoHandoffMeetDesc':
    'Google Meet कॉल खत्म होने पर, CloserEdge AI का ऑर्केस्ट्रेटर ट्रांसक्रिप्ट पढ़ सकता है और मैसेज ड्राफ्ट करना, फॉलो-अप शेड्यूल करना या Slack पर सारांश पोस्ट करना जैसे काम कर सकता है। डिफ़ॉल्ट रूप से बंद है।',
  ...
  'settings.search.menuDesc':
    'डिफ़ॉल्ट to CloserEdge AI -एक API कुंजी के साथ अपने स्वयं के प्रदाता को प्रबंधित खोज या तार करना।',
  'settings.search.description':
    'एजेंट द्वारा उपयोग किए जाने वाले सर्च इंजन को चुनें, या सर्च टूल्स को पूरी तरह बंद करें। Managed, CloserEdge AI के बैकएंड का उपयोग करता है (कोई सेटअप नहीं)। Parallel, Brave, और Querit आपकी API key का उपयोग करके सीधे आपकी मशीन से चलते हैं।',
  ...
  'settings.search.engineManagedLabel': 'CloserEdge AI प्रबंधित',
  'settings.search.engineManagedDesc': 'डिफ़ॉल्ट। CloserEdge AI backend — no API key required.',
  'settings.search.localManagedUnavailable':
    'लोकल उपयोगकर्ताओं के लिए CloserEdge Managed search उपलब्ध नहीं है। वेब सर्च चालू करने के लिए अपनी Parallel या Brave API key जोड़ें।',
  ...
  'devices.betaText':
    'यह सुविधा अभी बीटा में है। इस CloserEdge AI से iOS फ़ोन जोड़ें और उन्हें रिमोट क्लाइंट के रूप में उपयोग करें।',
  ...
  'devices.emptyState': 'अपने iPhone पर QR कोड स्कैन करें और इसे इस CloserEdge AI सत्र से जोड़ें।',
  ...
  'devices.pairModal.instructions':
    'अपने iPhone पर CloserEdge AI ऐप खोलें और इस कोड को स्कैन करें।',
  ...
  'mobile.tab.home': 'होम',
  'mobile.tab.chat': 'चैट',
  'mobile.tab.settings': 'सेटिंग्स',
  'mobileHome.greeting.morning': 'सुप्रभात',
  'mobileHome.greeting.afternoon': 'नमस्कार',
  'mobileHome.greeting.evening': 'शुभ संध्या',
  'mobileHome.themeToggle': 'डार्क मोड टॉगल करें',
  'mobileHome.status.title': 'आपका डेस्कटॉप',
  'mobileHome.status.checking': 'जाँच हो रही है…',
  'mobileHome.status.online': 'कनेक्टेड',
  'mobileHome.status.offline': 'पहुँच से बाहर',
  'mobileHome.status.manage': 'प्रबंधित करें',
  'mobileHome.transport.lan': 'लोकल नेटवर्क',
  'mobileHome.transport.tunnel': 'सुरक्षित टनल',
  'mobileHome.transport.cloud': 'क्लाउड रिले',
  'mobileHome.cta.title': 'अपने AI से बात करें',
  'mobileHome.cta.subtitle': 'बोलने के लिए दबाए रखें, या टाइप करें. आपकी बढ़त, एक टैप दूर.',
  'mobileHome.suggestions.title': 'यह पूछकर देखें',
  'mobileHome.suggestion.listing': 'लिस्टिंग का विवरण लिखें',
  'mobileHome.suggestion.followup': 'क्लाइंट फ़ॉलो-अप लिखें',
  'mobileHome.suggestion.plan': 'मेरा दिन प्लान करें',
  'mobileDevices.subtitle': 'इस फ़ोन से पेयर किए गए डेस्कटॉप.',
  'mobileDevices.pairAnother': 'दूसरा डिवाइस पेयर करें',
  'mobileDevices.empty': 'अभी तक कोई डेस्कटॉप पेयर नहीं किया गया.',
  'mobileWelcome.tagline': 'आपका AI कर्मचारी, आपकी जेब में.',
  'mobileWelcome.logIn': 'लॉग इन करें',
  'mobileWelcome.scanQr': 'QR कोड से पेयर करें',
  'mobileWelcome.hint':
    'अपने डेस्कटॉप और क्लाउड एजेंट से कनेक्ट करने के लिए लॉग इन करें, या अपने कंप्यूटर पर CloserEdge AI से QR कोड स्कैन करें.',
  'mobileLogin.title': 'लॉग इन करें',
  'mobileLogin.pickDesktop': 'एक डेस्कटॉप चुनें',
  'mobileLogin.email': 'ईमेल',
  'mobileLogin.password': 'पासवर्ड',
  'mobileLogin.signingIn': 'साइन इन हो रहा है…',
  'mobileLogin.loadingDesktops': 'आपके डेस्कटॉप खोजे जा रहे हैं…',
  'mobileLogin.noDesktops':
    'आपके खाते में अभी तक कोई डेस्कटॉप नहीं मिला. अपने कंप्यूटर पर CloserEdge AI खोलें और सेटिंग्स → डिवाइस में क्लाउड पेयरिंग चालू करें.',
  'mobileLogin.useQrInstead': 'इसके बजाय QR कोड से पेयर करें',
  'mobileLogin.desktopOnline': 'कनेक्ट करने के लिए तैयार',
  'mobileLogin.desktopOffline': 'ऑफ़लाइन — इस कंप्यूटर पर CloserEdge खोलें',
  'mobileLogin.connecting': '{label} से कनेक्ट हो रहा है…',
  'mobileLogin.error.expired':
    'यह डेस्कटॉप हाल ही में रिफ़्रेश नहीं हुआ — सुनिश्चित करें कि CloserEdge AI चल रहा है, फिर पुनः प्रयास करें.',
  'mobileLogin.error.unreachable': 'उस डेस्कटॉप तक नहीं पहुँच सका. क्या वह ऑनलाइन है?',
  'devices.cloudPairing.title': 'क्लाउड पेयरिंग',
  'devices.cloudPairing.body':
    'अपने CloserEdge खाते में साइन इन फ़ोन को QR कोड स्कैन किए बिना कनेक्ट करने दें.',
  ...
  'autonomy.maxActionsHelp':
    'प्रति रोलिंग घंटे में एजेंट अधिकतम कितने टूल एक्शन चला सकता है। नया मान अगली चैट पर लागू होगा। Cron जॉब्स और चैनल लिसनर CloserEdge AI को पुनः आरंभ करने तक अपनी मौजूदा सीमा बनाए रखते हैं।',
  ...
  'settings.tools.chooseCapabilities':
    'चुनें कि CloserEdge AI आपकी तरफ से कौन सी कैपेबिलिटीज़ इस्तेमाल कर सकता है।',
  ...
  'voice.providers.chip.cloud': 'CloserEdge AI (प्रबंधित)',
  'voice.providers.chip.cloudAria': 'CloserEdge AI प्रबंधित प्रोवाइडर हमेशा सक्षम रहता है',
  ...
  'bootCheck.desktopDescription':
    'CloserEdge AI को सोचने के लिए एक रनटाइम चाहिए। चुनें कि यह कहाँ रहे।',
  'bootCheck.webDescription':
    'वेब पर, CloserEdge AI आपके कंट्रोल के रनटाइम से कनेक्ट होता है। नीचे URL और auth टोकन डालें, या अपनी मशीन पर चलाने के लिए डेस्कटॉप ऐप लें।',
  ...
  'bootCheck.legacyDescription':
    'इस डिवाइस पर अलग से इन्स्टॉल किया CloserEdge AI daemon पहले से चल रहा है। बिल्ट-इन रनटाइम शुरू होने से पहले इसे हटाना होगा।',
  ...
  'bootCheck.portConflictBody':
    'कोई अन्य प्रक्रिया उस नेटवर्क पोर्ट का उपयोग कर रही है जो CloserEdge AI को चाहिए। हम इसे स्वचालित रूप से ठीक करने का प्रयास करेंगे।',
  ...
  'composio.expiredDescription':
    '{name} टूल को पुनः सक्षम करने के लिए पुनः कनेक्ट करें। CloserEdge AI इस एकीकरण को तब तक अनुपलब्ध रखेगा जब तक आप OAuth पहुंच को ताज़ा नहीं करते।',
  ...
  'app.connectionIndicator.connected': 'CloserEdge AI से कनेक्टेड 🚀',
  ...
  'app.openhumanLink.notifications.sent':
    'टेस्ट नोटिफ़िकेशन भेज दिया गया। यदि आपको प्राप्त नहीं हुआ, तो System Settings → Notifications → CloserEdge AI पर जाएँ, Allow Notifications चालू करें, और Banner Style को Persistent पर सेट करें।',
  ...
  'app.routeLoading.initializing': 'CloserEdge AI आरंभ हो रहा है...',
  ...
  'channels.authMode.managed_dm': 'CloserEdge AI से लॉगिन करें',
  ...
  'channels.discord.authMode.oauth.description':
    'CloserEdge AI बॉट को OAuth के माध्यम से अपने Discord सर्वर पर स्थापित करें।',
  'channels.discord.authMode.managed_dm.description':
    'अपने व्यक्तिगत Discord खाते को CloserEdge AI बॉट से लिंक करें।',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'CloserEdge AI Telegram बॉट को सीधे संदेश भेजें।',
  ...
  'iosPair.error.invalidQr':
    'अमान्य QR कोड। सुनिश्चित करें कि आप CloserEdge AI पेयरिंग कोड स्कैन कर रहे हैं।',
  ...
  'iosPair.instructions':
    'अपने डेस्कटॉप पर CloserEdge AI खोलें, Settings > Devices पर जाएं, और QR कोड दिखाने के लिए "Pair phone" टैप करें।',
  'iosPair.retryScan': 'पुनः स्कैन करने का प्रयास करें',
  'iosPair.scanQrCode': 'स्कैन QR code',
  'iosPair.scannerOpening': 'स्कैनर खुल रहा है...',
  'iosPair.step.openDesktop': 'डेस्कटॉप पर CloserEdge AI खोलें',
  ...
  'composio.connect.permissionsNoteSuffix':
    'CloserEdge AI की अपनी एजेंट अनुमतियाँ नीचे पढ़ें, लिखें और एडमिन टॉगल के रूप में नियंत्रित होती हैं।',
  ...
  'intelligence.diagram.imageAlt': 'CloserEdge AI का नवीनतम जेनरेटेड आर्किटेक्चर डायग्राम',
  ...
  'overlay.ariaOrb': 'CloserEdge AI ओवरले',
  ...
  'settings.ai.openhumanDefault': 'CloserEdge AI (डिफ़ॉल्ट)',
  ...
  'settings.ai.routing.managedDesc':
    'CloserEdge AI बादल में सभी अनुमान चला जाएगा, कार्य के लिए सबसे अच्छा मॉडल चुनें, लागत के लिए अनुकूलन करें और सबसे सुरक्षित रूटिंग डिफ़ॉल्ट रखें।',
  'settings.ai.routing.managedMsg':
    'CloserEdge AI प्रत्येक कार्यभार के लिए सभी अनुमानों को संभालेंगे और स्वचालित रूप से लागत, गुणवत्ता और सुरक्षा के लिए सबसे अच्छा मार्ग चुनें।',
  ...
  'settings.composio.confirmWarning':
    'आपके मौजूदा एकीकरण (Gmail, Slack, GitHub, आदि CloserEdge AI के माध्यम से लिंक किए गए) दिखाई नहीं देंगे — वे CloserEdge AI-प्रबंधित Composio टेनेंट में रहते हैं।',
  ...
  'settings.composio.modeManaged': 'मैनेज्ड (CloserEdge AI मैनेज करेगा)',
  'settings.composio.modeManagedDesc':
    'CloserEdge AI हमारे बैकएंड के माध्यम से टूल कॉल्स को प्रॉक्सी करता है (अनुशंसित)। प्रमाणीकरण ब्रोकर किया जाता है; आप कभी भी Composio API कुंजी पेस्ट नहीं करते। वेबहुक्स पूरी तरह से रूट किए जाते हैं।',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'CloserEdge AI अब Ollama को एक बाहरी इन्फ़रेंस रनटाइम के रूप में मानता है। अपना खुद का Ollama सर्वर शुरू करें, अपने इच्छित मॉडल खींचें, और वर्कलोड रूटिंग को इसकी ओर इंगित करें।',
  ...
  'settings.developerMenu.tools.desc':
    'CloserEdge AI आपकी ओर से जिन क्षमताओं का उपयोग कर सकता है, उन्हें सक्षम या अक्षम करें',
  ...
  'settings.developerMenu.mcpServer.desc':
    'CloserEdge AI से कनेक्ट करने के लिए बाहरी MCP क्लाइंट को कॉन्फ़िगर करें',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'CloserEdge AI बाइनरी नहीं मिली. यदि स्रोत से चल रहा है, तो इसके साथ निर्माण करें: cargo build --bin openhuman-core',
  ...
  'settings.mascot.colorAria': 'CloserEdge AI रंग',
  ...
  'settings.mascot.libraryUnavailable': 'CloserEdge AI लाइब्रेरी अनुपलब्ध है',
  'settings.mascot.title': 'CloserEdge AI',
  'settings.mascot.loadingLibrary': 'CloserEdge AI लाइब्रेरी लोड हो रही है…',
  ...
  'settings.mascot.localDefault': 'लोकल CloserEdge AI (डिफ़ॉल्ट)',
  'settings.mascot.menuTitle': 'मास्कॉट',
  'settings.mascot.menuDesc': 'ऐप में उपयोग होने वाला मास्कॉट रंग चुनें',
  'settings.mascot.noCharacters': 'अभी तक कोई CloserEdge AI कैरेक्टर उपलब्ध नहीं है',
  ...
  'settings.memoryWindow.description':
    'CloserEdge AI हर नए एजेंट रन में कितना याद किया गया संदर्भ इंजेक्ट करता है। बड़ी विंडोज़ पिछली बातचीत के बारे में अधिक जागरूक लगती हैं लेकिन हर रन पर अधिक टोकन का उपयोग करती हैं — और अधिक लागत आती है।',
  ...
  'skills.meetingBots.busyTitle': 'CloserEdge AI व्यस्त है',
  'skills.meetingBots.comingSoon': 'जल्द आ रहा है',
  'skills.meetingBots.couldNotStartTitle': 'CloserEdge AI प्रारंभ नहीं हो सका',
  'skills.meetingBots.displayName': 'डिस्प्ले नाम',
  'skills.meetingBots.failedToStart': 'CloserEdge AI शुरू नहीं हो पाया।',
  'skills.meetingBots.joiningMessage':
    'कुछ सेकंड में यह मीटिंग में पार्टिसिपेंट के रूप में दिखेगा।',
  'skills.meetingBots.joiningTitle': 'CloserEdge AI मीटिंग जॉइन कर रहा है',
  'skills.meetingBots.meetingLink': 'मीटिंग लिंक',
  'skills.meetingBots.modalAriaLabel': 'CloserEdge AI को मीटिंग में भेजें',
  'skills.meetingBots.modalDesc': 'मोडल विवरण',
  'skills.meetingBots.modalTitle': 'CloserEdge AI को मीटिंग में भेजें',
  ...
  'settings.mascot.noCharactersAvailable': 'अभी तक कोई CloserEdge AI कैरेक्टर उपलब्ध नहीं है',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'CloserEdge AI के बाहर Ollama प्रक्रिया और मॉडल पुल प्रबंधित करें, फिर डायग्नोस्टिक्स पुनः चलाएँ।',
  ...
  'devOptions.menuToolsDesc':
    'क्षमताओं को सक्षम या अक्षम करें CloserEdge AI आपकी ओर से उपयोग कर सकते हैं',
  ...
  'keyring.consent.description':
    'आपके ऑपरेटिंग सिस्टम का कीचेन सुलभ नहीं है। CloserEdge AI को इसके बजाय स्थानीय एन्क्रिप्टेड भंडारण का उपयोग करके रहस्य संग्रहीत करने के लिए आपकी अनुमति चाहिए।',
