...
const messages: TranslationMap = {
  ...
  'home.statusBrowserMode': '正在浏览器预览模式下运行。安装桌面应用以获得完整体验。',
  ...
  'app.connectionIndicator.browserMode': '浏览器模式',
  ...
  'home.banners.communitySubtitle': '获取支持、分享反馈，并与其他用户交流。',
  'home.banners.communityTitle': '加入我们的社区',
  ...
  'settings.mcpServer.toolsSectionDesc':
    '运行 closeredge-core mcp 时通过 MCP stdio 服务器暴露的工具',
  ...
  'settings.mcpServer.binaryPathNotFound':
    '未找到 CloserEdge AI 二进制文件。如果使用源码运行，请执行：cargo build --bin closeredge-core',
  ...
  'skills.create.scopeUserHint':
    '写入 ~/.closeredge/skills/<slug>/SKILL.md — 在所有工作空间中可用。',
