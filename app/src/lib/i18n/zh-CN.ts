...
const messages: TranslationMap = {
  ...
  'welcome.title': '欢迎使用 CloserEdge AI',
  ...
  'welcome.resetErrorFallback': '无法清除应用数据。请退出并重新打开 CloserEdge AI，然后重试。',
  ...
  'home.statusCoreUnreachable':
    '本地核心 sidecar 无响应。CloserEdge AI 后台进程可能已崩溃或未能启动。',
  ...
  'rewards.localUnavailable':
    '本地登录不会获得奖励、优惠券或推荐积分。若要累计奖励，请先登出，然后使用 CloserEdge AI 账号登录。',
  'rewards.localUnavailableCta': '打开账户设置',
  'rewards.credits': '配额',
  'rewards.referralCode': '你的邀请码',
  'rewards.copyCode': '复制邀请码',
  'rewards.share': '分享',
  'onboarding.welcome': '欢迎使用 CloserEdge AI',
  ...
  'onboarding.finishDesc': '一切就绪！开始使用 CloserEdge AI。',
  'onboarding.skip': '跳过',
  'onboarding.getStarted': '开始使用',
  'onboarding.runtimeChoice.title': '你希望如何运行 CloserEdge AI？',
  'onboarding.runtimeChoice.subtitle': '选择最适合你的设置。之后可在设置中更改。',
  'onboarding.runtimeChoice.cloud.title': '简单模式',
  'onboarding.runtimeChoice.cloud.tagline': '让 CloserEdge AI 为你管理一切。',
  ...
  'onboarding.custom.defaultSubtitle': '让 CloserEdge AI 为你管理。',
  ...
  'onboarding.custom.inference.defaultDesc':
    'CloserEdge AI 会为每种工作负载路由到合适的默认模型。无需密钥，无需设置。',
  ...
  'onboarding.custom.voice.defaultDesc':
    'CloserEdge AI 内置托管的 STT/TTS，开箱即用。无需额外配置。',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'CloserEdge AI 使用托管的 Composio 工作区。之后每个服务都可一键连接。',
  'onboarding.custom.oauth.configureDesc':
    '使用你自己的 Composio 账户或 API 密钥。在设置 › 连接中配置。',
  'onboarding.custom.search.title': '网页搜索',
  'onboarding.custom.search.subtitle': 'CloserEdge AI 如何代表你搜索网页。',
  'onboarding.custom.search.defaultDesc': 'CloserEdge AI 使用托管搜索后端。无需密钥。',
  'onboarding.custom.search.configureDesc':
    '使用你自己的搜索提供商密钥（Tavily、Brave 等）。在设置 › 工具中配置。',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle': 'CloserEdge AI 生成向量嵌入以实现语义记忆搜索的方式。',
  'onboarding.custom.embeddings.defaultDesc': 'CloserEdge AI 使用托管嵌入服务，无需 API 密钥。',
  'onboarding.custom.embeddings.configureDesc':
    '使用您自己的嵌入服务提供商（OpenAI、Voyage、Ollama 等）。',
  'onboarding.custom.memory.title': '记忆',
  'onboarding.custom.memory.subtitle': 'CloserEdge AI 如何记住你的上下文、偏好和历史对话。',
  'onboarding.custom.memory.defaultDesc': 'CloserEdge AI 会自动管理记忆存储和检索。无需设置。',
  ...
  'privacy.shareAnonymizedDataDesc':
    '通过分享匿名崩溃报告和使用分析来帮助改进 CloserEdge AI。所有数据完全匿名——不会收集任何个人数据、消息、钱包密钥或会话信息。',
  'privacy.meetingFollowUps': '会议跟进',
  'privacy.autoHandoffMeet': '自动将 Google Meet 转录交给编排器',
  'privacy.autoHandoffMeetDesc':
    '当 Google Meet 通话结束时，CloserEdge AI 的编排器可以阅读转录内容，并可能执行起草消息、安排跟进、或将摘要发布到已连接的 Slack 工作区等操作。默认关闭。',
  ...
  'settings.search.menuDesc': '默认使用 CloserEdge AI 托管搜索，或用 API 密钥接入你自己的提供商。',
  'settings.search.description':
    '选择智能体使用的搜索引擎。托管模式使用 CloserEdge AI 后端（无需设置）。Parallel、Brave 和 Querit 会用你的 API 密钥从本机直接调用。',
  'settings.search.engineAria': '搜索引擎',
  'settings.search.engineDisabledLabel': 'Disabled',
  'settings.search.engineDisabledDesc': '从智能体上下文和可用工具列表中移除搜索工具。',
  'settings.search.engineManagedLabel': 'CloserEdge AI 托管',
  'settings.search.engineManagedDesc': '默认选项。通过 CloserEdge AI 后端路由，无需 API 密钥。',
  'settings.search.localManagedUnavailable':
    '本地用户无法使用 CloserEdge AI 托管搜索。请添加你自己的 Parallel、Brave 或 Querit API 密钥以启用网页搜索。',
  ...
  'devices.pairModal.instructions': '打开 iPhone 上的 CloserEdge AI 应用程序并扫描此代码。',
  ...
  'mobileHome.greeting.morning': '早上好',
  'mobileHome.greeting.afternoon': '下午好',
  'mobileHome.greeting.evening': '晚上好',
  'mobileHome.themeToggle': '切换深色模式',
  'mobileHome.status.title': '你的桌面端',
  'mobileHome.status.checking': '正在检查…',
  'mobileHome.status.online': '已连接',
  'mobileHome.status.offline': '无法连接',
  'mobileHome.status.manage': '管理',
  'mobileHome.transport.lan': '本地网络',
  'mobileHome.transport.tunnel': '安全隧道',
  'mobileHome.transport.cloud': '云中继',
  'mobileHome.cta.title': '与你的 AI 对话',
  'mobileHome.cta.subtitle': '按住说话，或直接输入。你的优势，一触即达。',
  'mobileHome.suggestions.title': '试着问问',
  'mobileHome.suggestion.listing': '撰写房源描述',
  'mobileHome.suggestion.followup': '撰写客户跟进信息',
  'mobileHome.suggestion.plan': '规划我的一天',
  'mobileDevices.subtitle': '与此手机配对的桌面端。',
  'mobileDevices.pairAnother': '配对另一台设备',
  'mobileDevices.empty': '尚未配对任何桌面端。',
  'mobileWelcome.tagline': '你的 AI 员工，装进口袋。',
  'mobileWelcome.logIn': '登录',
  'mobileWelcome.scanQr': '用二维码配对',
  'mobileWelcome.hint': '登录以连接你的桌面端和云端代理，或在电脑上扫描 CloserEdge AI 中的二维码。',
  'mobileLogin.title': '登录',
  'mobileLogin.pickDesktop': '选择一台桌面端',
  'mobileLogin.email': '邮箱',
  'mobileLogin.password': '密码',
  'mobileLogin.signingIn': '正在登录…',
  'mobileLogin.loadingDesktops': '正在查找你的桌面端…',
  'mobileLogin.noDesktops':
    '尚未在你的账户中找到桌面端。请在电脑上打开 CloserEdge AI，并在“设置 → 设备”中开启云配对。',
  'mobileLogin.useQrInstead': '改用二维码配对',
  'mobileLogin.desktopOnline': '可以连接',
  'mobileLogin.desktopOffline': '离线 — 请在这台电脑上打开 CloserEdge',
  'mobileLogin.connecting': '正在连接到 {label}…',
  'mobileLogin.error.expired': '该桌面端最近没有刷新 — 请确认 CloserEdge AI 正在运行，然后重试。',
  'mobileLogin.error.unreachable': '无法连接到该桌面端。它在线吗？',
  'devices.cloudPairing.title': '云配对',
  'devices.cloudPairing.body': '让已登录你 CloserEdge 账户的手机无需扫描二维码即可连接。',
  ...
  'autonomy.maxActionsHelp':
    '智能体每滚动小时内可执行的最大工具操作次数。新值将在下次对话时生效。定时任务和频道监听器将保持当前限制，直到重启 CloserEdge AI。',
  ...
  'settings.tools.chooseCapabilities': '选择 CloserEdge AI 可代表你使用的能力。',
  ...
  'voice.providers.chip.cloud': 'CloserEdge AI（托管）',
  'voice.providers.chip.cloudAria': 'CloserEdge AI 托管服务商始终启用',
  ...
  'bootCheck.desktopDescription': 'CloserEdge AI 需要一个运行中的核心才能工作。请选择连接方式。',
  'bootCheck.webDescription':
    '网页版 CloserEdge AI 连接到由你控制的远程核心。请输入其 URL 和认证令牌，或安装桌面版在本地运行核心。',
  ...
  'bootCheck.legacyDescription':
    '此设备上正在运行一个单独安装的 CloserEdge AI 守护进程。必须先将其移除，嵌入式核心才能接管。',
  ...
  'bootCheck.portConflictBody':
    '另一个进程正在占用 CloserEdge AI 所需的网络端口。我们将尝试自动修复此问题。',
  ...
  'composio.expiredDescription':
    '重新连接以重新启用 {name} 工具。 CloserEdge AI 将保持此集成不可用，直到您刷新 OAuth 访问权限。',
  ...
  'app.connectionIndicator.connected': '已连接到 CloserEdge AI',
  ...
  'app.openhumanLink.notifications.blockedStep2': '找到 CloserEdge AI',
  ...
  'app.openhumanLink.notifications.sent':
    '测试通知已发送。如果未收到，请前往「系统设置 → 通知 → CloserEdge AI」，开启「允许通知」并将横幅样式设置为「持续」。',
  ...
  'app.routeLoading.initializing': '正在初始化 CloserEdge AI...',
  ...
  'channels.authMode.managed_dm': '使用 CloserEdge AI 登录',
  ...
  'channels.discord.authMode.oauth.description':
    '通过 OAuth 将 CloserEdge AI 机器人安装到你的 Discord 服务器。',
  'channels.discord.authMode.managed_dm.description':
    '将你的个人 Discord 账户关联到 CloserEdge AI 机器人。',
  ...
  'channels.telegram.authMode.managed_dm.description':
    '直接向 CloserEdge AI Telegram 机器人发送消息。',
  ...
  'composio.connect.permissionsNoteSuffix':
    'CloserEdge AI 自身的智能体权限通过下方的读取、写入和管理员开关控制。',
  ...
  'daemon.serviceBlockingGate.title': 'CloserEdge AI 核心不可用',
  ...
  'intelligence.diagram.imageAlt': '最新生成的 CloserEdge AI 架构图',
  ...
  'overlay.ariaOrb': 'CloserEdge AI 浮层',
  ...
  'settings.ai.openhumanDefault': 'CloserEdge AI（默认）',
  ...
  'settings.ai.routing.managedDesc':
    'CloserEdge AI 会在云端运行所有推理，为任务选择最佳模型，优化成本，并保持最安全的路由默认值。',
  'settings.ai.routing.managedMsg':
    'CloserEdge AI 会处理每个工作负载的全部推理，并自动选择兼顾成本、质量和安全性的最佳路线。',
  ...
  'settings.composio.confirmWarning':
    '你现有的集成（通过 CloserEdge AI 关联的 Gmail、Slack、GitHub 等）将不可见——它们存放在 CloserEdge AI 托管的 Composio 租户中。',
  ...
  'settings.composio.modeManaged': '托管（由 CloserEdge AI 管理）',
  'settings.composio.modeManagedDesc':
    'CloserEdge AI 通过我们的后端代理工具调用（推荐）。认证由我们处理，你无需粘贴 Composio API 密钥。Webhook 完全路由。',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'CloserEdge AI 现在将 Ollama 视为外部推理运行时。请启动你自己的 Ollama 服务器，拉取所需模型，并将工作负载路由指向它。',
  ...
  'settings.developerMenu.tools.desc': '启用或停用 CloserEdge AI 可代表你使用的能力',
  ...
  'settings.developerMenu.mcpServer.desc': '配置外部 MCP 客户端以连接到 CloserEdge AI',
  ...
  'settings.mcpServer.binaryPathNotFound':
    '未找到 CloserEdge AI 二进制文件。如果使用源码运行，请执行：cargo build --bin openhuman-core',
  ...
  'settings.mascot.characterDesc': '选择你的 CloserEdge AI 角色',
  ...
  'settings.mascot.colorAria': 'CloserEdge AI 颜色',
  ...
  'settings.mascot.libraryUnavailable': 'CloserEdge AI 资源库不可用',
  'settings.mascot.title': 'CloserEdge AI',
  'settings.mascot.loadingLibrary': '正在加载 CloserEdge AI 库…',
  'settings.mascot.loadDetailError': '无法加载吉祥物。',
  'settings.mascot.loadLibraryError': '无法加载吉祥物库。',
  'settings.mascot.localDefault': '本地 CloserEdge AI（默认）',
  'settings.mascot.menuTitle': '吉祥物',
  'settings.mascot.menuDesc': '选择应用内使用的吉祥物颜色',
  'settings.mascot.noCharacters': '暂无可用的 CloserEdge AI 角色',
  ...
  'settings.memoryWindow.description':
    'CloserEdge AI 在每次新的智能体运行中注入多少记忆上下文。更大的窗口对过往对话更有感知，但每次运行会消耗更多 token，成本也更高。',
  ...
  'skills.meetingBots.bannerDesc': '让 CloserEdge AI 加入你的会议，自动记录摘要',
  'skills.meetingBots.bannerTitle': '会议机器人',
  'skills.meetingBots.busyTitle': 'CloserEdge AI 正忙',
  'skills.meetingBots.comingSoon': '即将推出',
  'skills.meetingBots.couldNotStartTitle': '无法启动 CloserEdge AI',
  'skills.meetingBots.displayName': '显示名称',
  'skills.meetingBots.failedToStart': '启动 CloserEdge AI 失败。',
  'skills.meetingBots.joiningMessage': '它应该在几秒钟内作为参会者出现。',
  'skills.meetingBots.joiningTitle': 'CloserEdge AI 正在加入会议',
  'skills.meetingBots.meetingLink': '会议链接',
  'skills.meetingBots.modalAriaLabel': '将 CloserEdge AI 发送到会议',
  'skills.meetingBots.modalDesc': '输入会议链接，让 CloserEdge AI 作为参会者加入并记录内容。',
  'skills.meetingBots.modalTitle': '将 CloserEdge AI 发送到会议',
  ...
  'settings.mascot.noCharactersAvailable': '暂无可用的 CloserEdge AI 角色',
  ...
  'settings.localModel.status.manageOllamaExternal':
    '请在 CloserEdge AI 之外管理 Ollama 进程和模型拉取，然后重新运行诊断。',
  ...
  'devOptions.menuToolsDesc': '启用或禁用 CloserEdge AI 可代表你使用的能力',
  ...
  'keyring.consent.description':
    '您的操作系统密钥链不可访问。CloserEdge AI 需要您的许可，以便使用本地加密存储来保存密钥。',
