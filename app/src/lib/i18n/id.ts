...
const messages: TranslationMap = {
  ...
  'home.statusBrowserMode':
    'Berjalan dalam mode pratinjau browser. Instal aplikasi desktop untuk pengalaman lengkap.',
  ...
  'onboarding.finishDesc': 'Semua siap! Mulai gunaka CloserEdge AI.',
  'onboarding.skip': 'Lewati',
  'onboarding.getStarted': 'Mulai',
  'onboarding.runtimeChoice.title': 'Bagaimana Anda ingin menjalanka CloserEdge AI?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Biarka CloserEdge AI mengelola segalanya untuk Anda.',
  ...
  'onboarding.custom.defaultSubtitle': 'Biarka CloserEdge AI mengelolanya untuk Anda.',
  ...
  'invites.statusExpired': 'Status kedaluwarsa',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Bantu meningkatka CloserEdge AI dengan membagikan laporan crash dan analitik penggunaan anonim. Semua data sepenuhnya anonim; tidak ada data pribadi, pesan, kunci dompet, atau informasi sesi yang dikumpulkan.',
  ...
  'settings.search.localManagedUnavailable':
    'Pencaria CloserEdge AI Managed tidak tersedia untuk pengguna lokal. Tambahkan API key Parallel atau Brave Anda sendiri untuk mengaktifkan pencarian web.',
  ...
  'devices.betaText':
    'Fitur ini sedang dalam versi beta. Pasangkan ponsel iOS denga CloserEdge AI ini untuk menggunakannya sebagai klien jarak jauh.',
  ...
  'settings.tools.chooseCapabilities':
    'Pilih kemampuan yang dapat digunaka CloserEdge AI atas nama Anda.',
  ...
  'bootCheck.portConflictBody':
    'Proses lain sedang menggunakan port jaringan yang dibutuhka CloserEdge AI. Kami akan mencoba memperbaikinya secara otomatis.',
  ...
  'app.connectionIndicator.browserMode': 'Mode Browser',
  ...
  'channels.authMode.managed_dm': 'Masuk denga CloserEdge AI',
  ...
  'settings.localModel.download.summaryHelper':
    'Panggilan `closeredge.inference_summarize` melalui Rust core',
  ...
  'settings.developerMenu.tools.desc':
    'Aktifkan atau nonaktifkan kemampuan yang bisa digunaka CloserEdge AI atas nama Anda',
  ...
  'settings.mcpServer.toolsSectionDesc':
    'Alat yang diekspos melalui server stdio MCP saat menjalankan closeredge-core mcp',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Binary CloserEdge AI tidak ditemukan. Jika menjalankan dari source, build dengan: cargo build --bin closeredge-core',
  ...
  'skills.create.scopeUserHint':
    'Ditulis ke ~/.closeredge/skills/<slug>/SKILL.md — tersedia di semua workspace.',
  ...
  'skills.install.errors.writeFailedHint':
    'Direktori keterampilan ruang kerja tidak dapat ditulis. Periksa izin sistem file untuk `<workspace>/.closeredge/skills/`.',
  ...
  'devOptions.menuToolsDesc':
    'Aktifkan atau nonaktifkan kemampuan yang dapat digunaka CloserEdge AI atas nama Anda',
  ...
  'mobile.tab.home': 'Beranda',
  'mobile.tab.chat': 'Obrolan',
  'mobile.tab.settings': 'Pengaturan',
  'mobileHome.greeting.morning': 'Selamat pagi',
  'mobileHome.greeting.afternoon': 'Selamat siang',
  'mobileHome.greeting.evening': 'Selamat malam',
  'mobileHome.themeToggle': 'Alihkan mode gelap',
  'mobileHome.status.title': 'Desktop Anda',
  'mobileHome.status.checking': 'Memeriksa…',
  'mobileHome.status.online': 'Terhubung',
  'mobileHome.status.offline': 'Tidak dapat dijangkau',
  'mobileHome.status.manage': 'Kelola',
  'mobileHome.transport.lan': 'Jaringan lokal',
  'mobileHome.transport.tunnel': 'Terowongan aman',
  'mobileHome.transport.cloud': 'Relai cloud',
  'mobileHome.cta.title': 'Bicara dengan AI Anda',
  'mobileHome.cta.subtitle': 'Tahan untuk bicara, atau ketik. Keunggulan Anda, satu ketukan saja.',
  'mobileHome.suggestions.title': 'Coba tanyakan',
  ...
  'mobileWelcome.hint':
    'Masuk untuk terhubung ke desktop dan agen cloud Anda, atau pindai kode QR dari CloserEdge AI di komputer Anda.',
  'mobileLogin.title': 'Masuk',
  'mobileLogin.pickDesktop': 'Pilih desktop',
  'mobileLogin.email': 'Email',
  'mobileLogin.password': 'Kata sandi',
  'mobileLogin.signingIn': 'Masuk…',
  'mobileLogin.loadingDesktops': 'Mencari desktop Anda…',
  'mobileLogin.noDesktops':
    'Belum ada desktop yang ditemukan di akun Anda. Buka CloserEdge AI di komputer Anda dan aktifkan Pemasangan Cloud di Pengaturan → Perangkat.',
  'mobileLogin.useQrInstead': 'Pasangkan dengan kode QR saja',
  'mobileLogin.desktopOnline': 'Siap terhubung',
  'mobileLogin.desktopOffline': 'Offline — buka CloserEdge di komputer ini',
  'mobileLogin.connecting': 'Menghubungkan ke {label}…',
  'mobileLogin.error.expired':
    'Desktop itu belum diperbarui baru-baru ini — pastikan CloserEdge AI berjalan, lalu coba lagi.',
  'mobileLogin.error.unreachable': 'Tidak dapat menjangkau desktop itu. Apakah sedang online?',
  'devices.cloudPairing.title': 'Pemasangan cloud',
  'devices.cloudPairing.body':
    'Izinkan ponsel yang masuk ke akun CloserEdge Anda terhubung tanpa memindai kode QR.',
