...
const messages: TranslationMap = {
  ...
  'rewards.localUnavailable':
    'Локальный вход не приносит награды, купоны или реферальный кредит. Выйдите и войдите с аккаунтом CloserEdge AI, если хотите, чтобы награды начислялись.',
  ...
  'settings.search.localManagedUnavailable':
    'Поиск CloserEdge Managed недоступен для локальных пользователей. Добавьте свой ключ API Parallel или Brave, чтобы включить веб-поиск.',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Двоичный файл CloserEdge AI не найден. При запуске из исходного кода выполните сборку с помощью: Cargo build --bin openhuman-core',
  ...
  'settings.mascot.colorAria': 'CloserEdge AI цвет',
  ...
  'settings.mascot.libraryUnavailable': 'CloserEdge AI библиотека недоступна',
  'settings.mascot.title': 'CloserEdge AI',
  'settings.mascot.loadingLibrary': 'Загрузка библиотеки CloserEdge AI…',
  ...
  'settings.mascot.localDefault': 'Локальный CloserEdge AI (по умолчанию)',
  'settings.mascot.menuTitle': 'Маскот',
  'settings.mascot.menuDesc': 'Выберите цвет маскота, используемый во всем приложении',
  'settings.mascot.noCharacters': 'Персонажи CloserEdge AI пока недоступны',
  ...
  'settings.mascot.noCharactersAvailable': 'Персонажи CloserEdge AI пока недоступны',
