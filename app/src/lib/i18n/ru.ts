...
const messages: TranslationMap = {
  ...
  'welcome.title': 'Добро пожаловать в CloserEdge AI',
  ...
  'welcome.resetErrorFallback':
    'Не удалось очистить данные приложения. Закройте и снова откройте CloserEdge AI, затем повторите попытку.',
  ...
  'home.statusCoreUnreachable':
    'Локальный процесс CloserEdge AI не отвечает. Возможно, он завис или не запустился.',
  'home.statusInternetOffline':
    'Нет подключения к интернету. Проверь сеть или перезапусти приложение.',
  'home.statusBrowserMode':
    'Запущено в режиме предварительного просмотра браузера. Установи десктопное приложение для полного доступа.',
  ...
  'onboarding.welcome': 'Привет. Я CloserEdge AI.',
  ...
  'onboarding.finishDesc': 'Всё готово! Начни пользоваться CloserEdge AI.',
  'onboarding.skip': 'Пропустить',
  'onboarding.getStarted': 'Начать',
  'onboarding.runtimeChoice.title': 'Как ты хочешь запустить CloserEdge AI?',
  ...
  'onboarding.runtimeChoice.cloud.tagline': 'Пусть CloserEdge AI сам обо всём позаботится.',
  ...
  'onboarding.custom.defaultSubtitle': 'Пусть CloserEdge AI сам управляет этим.',
  ...
  'onboarding.custom.inference.defaultDesc':
    'CloserEdge AI автоматически выбирает подходящую модель. Без ключей и настроек.',
  ...
  'onboarding.custom.voice.defaultDesc':
    'CloserEdge AI поставляется с управляемым STT/TTS, который работает сразу. Ничего настраивать не нужно.',
  ...
  'onboarding.custom.oauth.defaultDesc':
    'CloserEdge AI использует управляемое рабочее пространство Composio. Один клик для подключения каждого сервиса.',
  ...
  'onboarding.custom.search.subtitle': 'Как CloserEdge AI ищет информацию в интернете.',
  'onboarding.custom.search.defaultDesc':
    'CloserEdge AI использует управляемый поисковый бэкенд. Ключи не нужны.',
  'onboarding.custom.search.configureDesc':
    'Используй свой ключ поискового провайдера (Tavily, Brave и др.). Настрой в Настройки › Инструменты.',
  'onboarding.custom.embeddings.title': 'Embeddings',
  'onboarding.custom.embeddings.subtitle':
    'Как CloserEdge AI создаёт векторные эмбеддинги для семантического поиска в памяти.',
  'onboarding.custom.embeddings.defaultDesc':
    'CloserEdge AI использует управляемый сервис эмбеддингов. API-ключ не требуется.',
  ...
  'onboarding.custom.memory.subtitle':
    'Как CloserEdge AI запоминает контекст, предпочтения и предыдущие разговоры.',
  'onboarding.custom.memory.defaultDesc':
    'CloserEdge AI автоматически управляет хранением и извлечением воспоминаний. Ничего настраивать не нужно.',
  ...
  'invites.statusExpired': 'Истёк срок',
  ...
  'misc.beta':
    'CloserEdge AI находится в стадии раннего бета-тестирования. Делись отзывами и сообщай об ошибках — каждый репорт помогает нам двигаться быстрее.',
  ...
  'privacy.shareAnonymizedDataDesc':
    'Помоги улучшить CloserEdge AI, отправляя анонимные отчёты об ошибках и данные об использовании. Все данные полностью анонимизированы — личные данные, сообщения, ключи кошелька и информация о сессии никогда не собираются.',
  ...
  'privacy.autoHandoffMeetDesc':
    'Когда звонок в Google Meet заканчивается, оркестратор CloserEdge AI может прочитать транскрипт и выполнить действия: составить сообщения, запланировать задачи или опубликовать итоги в Slack. По умолчанию выключено.',
  ...
  'settings.search.menuDesc':
    'По умолчанию используется поиск, управляемый CloserEdge AI, или подключите собственного провайдера с помощью ключа API.',
  'settings.search.description':
    'Выберите поисковую систему, которую использует агент, или полностью отключите инструменты поиска. Управляемый режим использует серверную часть CloserEdge AI (настройка не требуется). Parallel, Brave и Querit работают напрямую с вашего устройства, используя ваш API-ключ.',
  ...
  'settings.search.engineManagedLabel': 'CloserEdge AI Управляемый',
  'settings.search.engineManagedDesc':
    'По умолчанию. Маршрутизируется через серверную часть CloserEdge AI — ключ API не ​​требуется.',
  'settings.search.localManagedUnavailable':
    'Поиск CloserEdge AI Managed недоступен для локальных пользователей. Добавьте свой ключ API Parallel или Brave, чтобы включить веб-поиск.',
  ...
  'devices.betaText':
    'Эта функция находится в стадии бета-тестирования. Подключите iPhone к этому CloserEdge AI для использования в качестве удалённого клиента.',
  ...
  'devices.emptyState':
    'Отсканируйте QR-код на своём iPhone, чтобы подключить его к текущей сессии CloserEdge AI.',
  ...
  'devices.pairModal.instructions':
    'Откройте приложение CloserEdge AI на iPhone и отсканируйте этот код.',
  ...
  'autonomy.maxActionsHelp':
    'Максимальное количество действий инструментов, которое агент может выполнить за скользящий час. Новое значение применяется к следующему чату. Задания cron и слушатели каналов сохраняют текущий лимит до перезапуска CloserEdge AI.',
  ...
  'settings.tools.chooseCapabilities':
    'Выбери, какие возможности CloserEdge AI может использовать от твоего имени.',
  ...
  'voice.providers.chip.cloud': 'CloserEdge AI (управляемый)',
  'voice.providers.chip.cloudAria': 'Управляемый провайдер CloserEdge AI всегда включён',
  ...
  'bootCheck.desktopDescription':
    'CloserEdge AI нужна среда выполнения для работы. Выбери, где она должна находиться.',
  'bootCheck.webDescription':
    'В браузере CloserEdge AI подключается к среде выполнения под твоим управлением. Введи URL и токен авторизации, или скачай настольное приложение для локального запуска.',
  ...
  'bootCheck.legacyDescription':
    'На этом устройстве уже запущен отдельно установленный демон CloserEdge AI. Нужно его убрать, прежде чем встроенная среда сможет взять управление.',
  ...
  'bootCheck.portConflictBody':
    'Другой процесс использует сетевой порт, необходимый CloserEdge AI. Попробуем устранить это автоматически.',
  ...
  'composio.expiredDescription':
    'Повторно подключитесь, чтобы повторно включить инструменты {name}. CloserEdge AI будет держать эту интеграцию недоступной, пока вы не обновите доступ к OAuth.',
  ...
  'app.connectionIndicator.connected': 'Подключено к CloserEdge AI 🚀',
  ...
  'app.connectionIndicator.browserMode': 'Режим браузера',
  ...
  'app.openhumanLink.notifications.sent':
    'Тестовое уведомление отправлено. Если вы его не получили, откройте «Системные настройки» → «Уведомления» → CloserEdge AI, включите «Разрешить уведомления» и установите стиль баннера «Постоянный».',
  ...
  'app.routeLoading.initializing': 'Инициализация CloserEdge AI...',
  ...
  'channels.authMode.managed_dm': 'Войдите с помощью CloserEdge AI',
  ...
  'channels.discord.authMode.oauth.description':
    'Установите бот CloserEdge AI на свой сервер Discord через OAuth.',
  'channels.discord.authMode.managed_dm.description':
    'Свяжите свою личную учетную запись Discord с ботом CloserEdge AI.',
  ...
  'channels.telegram.authMode.managed_dm.description':
    'Отправьте сообщение боту CloserEdge AI Telegram напрямую.',
  ...
  'iosPair.error.invalidQr':
    'Неверный QR-код. Убедитесь, что вы сканируете код сопряжения CloserEdge AI.',
  ...
  'iosPair.instructions':
    'Откройте CloserEdge AI на рабочем столе, перейдите в Настройки > Устройства и нажмите «Привязать телефон», чтобы показать QR-код.',
  'iosPair.retryScan': 'Повторить сканирование',
  'iosPair.scanQrCode': 'Сканирование QR code',
  'iosPair.scannerOpening': 'Открытие сканера...',
  'iosPair.step.openDesktop': 'Откройте CloserEdge AI на рабочем столе',
  ...
  'composio.connect.permissionsNoteSuffix':
    'Собственные права агента CloserEdge AI настраиваются ниже переключателями чтения, записи и администратора.',
  ...
  'intelligence.diagram.imageAlt':
    'Последняя сгенерированная архитектурная диаграмма CloserEdge AI',
  ...
  'overlay.ariaOrb': 'Оверлей CloserEdge AI',
  ...
  'settings.ai.openhumanDefault': 'CloserEdge AI (по умолчанию)',
  ...
  'settings.ai.routing.managedDesc':
    'CloserEdge AI выполнит все логические выводы в облаке, выберет лучшую модель для задачи, оптимизирует затраты и сохранит самые безопасные настройки маршрутизации по умолчанию.',
  'settings.ai.routing.managedMsg':
    'CloserEdge AI будет обрабатывать все выводы для каждой рабочей нагрузки и автоматически выбирать лучший маршрут с точки зрения стоимости, качества и безопасности.',
  ...
  'settings.composio.confirmWarning':
    'Ваши существующие интеграции (Gmail, Slack, GitHub и т. д., привязанные через CloserEdge AI) не будут видны — они находятся в управляемом CloserEdge AI тенанте Composio.',
  ...
  'settings.composio.modeManaged': 'Управляемый (CloserEdge AI управляет за тебя)',
  'settings.composio.modeManagedDesc':
    'CloserEdge AI проксирует вызовы инструментов через наш бэкенд (рекомендуется). Авторизация брокеруется; вам не нужно вставлять API-ключ Composio. Вебхуки полностью маршрутизируются.',
  ...
  'settings.localModel.download.summaryHelper':
    'Вызовы `closeredge.inference_summarize` через ядро Rust',
  ...
  'settings.localModel.status.ollamaNotInstalledDesc':
    'CloserEdge AI теперь рассматривает Ollama как внешнюю среду инференса. Запустите собственный сервер Ollama, загрузите нужные модели и направьте маршрутизацию нагрузки на него.',
  ...
  'settings.developerMenu.tools.desc':
    'Включайте или отключайте возможности, которые CloserEdge AI может использовать от вашего имени',
  ...
  'settings.developerMenu.mcpServer.desc':
    'Настройка внешних клиентов MCP для подключения к серверу CloserEdge AI',
  ...
  'settings.mcpServer.toolsSectionDesc':
    'Инструменты, предоставляемые через сервер MCP stdio при запуске closeredge-core mcp',
  ...
  'settings.mcpServer.binaryPathNotFound':
    'Двоичный файл CloserEdge AI не найден. При запуске из исходного кода выполните сборку с помощью: Cargo build --bin closeredge-core',
  ...
  'settings.memoryWindow.description':
    'Сколько запомненного контекста CloserEdge AI добавляет в каждый новый запуск агента. Более широкие окна дают ощущение лучшей памяти о прошлых разговорах, но используют больше токенов — и стоят дороже — на каждом запуске.',
  ...
  'skills.create.scopeUserHint':
    'Записывается в ~/.closeredge/skills/<slug>/SKILL.md — доступно во всех рабочих пространствах.',
  ...
  'skills.install.errors.writeFailedHint':
    'Каталог навыков рабочей области не был доступен для записи. Проверьте разрешения файловой системы для `<workspace>/.closeredge/skills/`.',
  ...
  'skills.meetingBots.busyTitle': 'CloserEdge AI занят',
  'skills.meetingBots.comingSoon': 'Скоро',
  'skills.meetingBots.couldNotStartTitle': 'Не удалось запустить CloserEdge AI',
  'skills.meetingBots.displayName': 'Отображаемое имя',
  'skills.meetingBots.failedToStart': 'Не удалось запустить CloserEdge AI.',
  'skills.meetingBots.joiningMessage': 'Он должен появиться как участник через несколько секунд.',
  'skills.meetingBots.joiningTitle': 'CloserEdge AI подключается к встрече',
  'skills.meetingBots.meetingLink': 'Ссылка на встречу',
  'skills.meetingBots.modalAriaLabel': 'Отправить CloserEdge AI на встречу',
  'skills.meetingBots.modalDesc': 'Описание окна',
  'skills.meetingBots.modalTitle': 'Отправить CloserEdge AI на встречу',
  ...
  'settings.localModel.status.manageOllamaExternal':
    'Управляйте процессом Ollama и загрузкой моделей вне CloserEdge AI, затем повторите диагностику.',
  ...
  'devOptions.menuToolsDesc':
    'Включение или отключение возможностей, которые CloserEdge AI может использовать от вашего имени',
  ...
  'keyring.consent.description':
    'Связка ключей вашей операционной системы недоступна. CloserEdge AI необходимо ваше разрешение на хранение секретов в локальном зашифрованном хранилище.',
  ...
  'mobile.tab.home': 'Главная',
  'mobile.tab.chat': 'Чат',
  'mobile.tab.settings': 'Настройки',
  'mobileHome.greeting.morning': 'Доброе утро',
  'mobileHome.greeting.afternoon': 'Добрый день',
  'mobileHome.greeting.evening': 'Добрый вечер',
  'mobileHome.themeToggle': 'Переключить тёмную тему',
  'mobileHome.status.title': 'Ваш компьютер',
  'mobileHome.status.checking': 'Проверка…',
  'mobileHome.status.online': 'Подключено',
  'mobileHome.status.offline': 'Недоступно',
  'mobileHome.status.manage': 'Управление',
  'mobileHome.transport.lan': 'Локальная сеть',
  'mobileHome.transport.tunnel': 'Защищённый туннель',
  'mobileHome.transport.cloud': 'Облачный ретранслятор',
  'mobileHome.cta.title': 'Поговорите со своим ИИ',
  'mobileHome.cta.subtitle':
    'Удерживайте, чтобы говорить, или печатайте. Ваше преимущество — в одном касании.',
  'mobileHome.suggestions.title': 'Попробуйте спросить',
  'mobileHome.suggestion.listing': 'Составить описание объявления',
  'mobileHome.suggestion.followup': 'Написать сообщение клиенту',
  'mobileHome.suggestion.plan': 'Спланировать мой день',
  'mobileDevices.subtitle': 'Компьютеры, связанные с этим телефоном.',
  'mobileDevices.pairAnother': 'Связать другое устройство',
  'mobileDevices.empty': 'Пока нет связанных компьютеров.',
  'mobileWelcome.tagline': 'Ваш ИИ-сотрудник у вас в кармане.',
  'mobileWelcome.logIn': 'Войти',
  'mobileWelcome.scanQr': 'Связать по QR-коду',
  'mobileWelcome.hint':
    'Войдите, чтобы подключиться к своим компьютерам и облачным агентам, или отсканируйте QR-код из CloserEdge AI на компьютере.',
  'mobileLogin.title': 'Войти',
  'mobileLogin.pickDesktop': 'Выберите компьютер',
  'mobileLogin.email': 'Эл. почта',
  'mobileLogin.password': 'Пароль',
  'mobileLogin.signingIn': 'Вход…',
  'mobileLogin.loadingDesktops': 'Поиск ваших компьютеров…',
  'mobileLogin.noDesktops':
    'На вашем аккаунте пока не найдено компьютеров. Откройте CloserEdge AI на компьютере и включите облачное связывание в разделе Настройки → Устройства.',
  'mobileLogin.useQrInstead': 'Связать по QR-коду вместо этого',
  'mobileLogin.desktopOnline': 'Готов к подключению',
  'mobileLogin.desktopOffline': 'Не в сети — откройте CloserEdge на этом компьютере',
  'mobileLogin.connecting': 'Подключение к {label}…',
  'mobileLogin.error.expired':
    'Этот компьютер давно не обновлялся — убедитесь, что CloserEdge AI запущен, и повторите попытку.',
  'mobileLogin.error.unreachable': 'Не удалось связаться с этим компьютером. Он в сети?',
  'devices.cloudPairing.title': 'Облачное связывание',
  'devices.cloudPairing.body':
    'Разрешите телефонам, вошедшим в ваш аккаунт CloserEdge, подключаться без сканирования QR-кода.',
