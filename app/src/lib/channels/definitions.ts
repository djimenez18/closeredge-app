...
export const AUTH_MODE_LABELS: Record<string, string> = {
  managed_dm: 'Login with CloserEdge AI',
  oauth: 'OAuth Sign-in',
...
export const FALLBACK_DEFINITIONS: ChannelDefinition[] = [
  {
    ...
    auth_modes: [
      {
        mode: 'managed_dm',
        description: 'Message the CloserEdge AI Telegram bot directly.',
        fields: [],
  ...
  },
  {
    ...
    auth_modes: [
      ...
      {
        mode: 'oauth',
        description: 'Install the CloserEdge AI bot to your Discord server via OAuth.',
        fields: [],
        auth_action: 'discord_oauth',
      },
      {
        mode: 'managed_dm',
        description: 'Link your personal Discord account to the CloserEdge AI bot.',
        fields: [],
