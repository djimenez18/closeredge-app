...
describe('Rewards page', () => {
  ...
  it('shows a local-only message and skips rewards fetch for local sessions', () => {
    ...
    expect(
      screen.getByText(
        'Local login does not earn rewards, coupons, or referral credit. To earn rewards, log out and continue by signing in with an CloserEdge AI account.'
      )
    ).toBeInTheDocument();
  });
      ...
      achievements: [
        {
          id: 'STREAK_7',
          title: '7-Day Streak',
          description: 'Use CloserEdge AI on seven consecutive active days.',
