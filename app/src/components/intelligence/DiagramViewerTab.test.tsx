...
describe('DiagramViewerTab', () => {
  it('refreshes the diagram image URL on demand', async () => {
    ...
    const image = await screen.findByRole('img', {
      name: 'Latest generated CloserEdge AI architecture diagram',
    });
    ...
    expect(
      screen.getByRole('img', { name: 'Latest generated CloserEdge AI architecture diagram' })
  ...
  it('shows an empty state instead of a broken image after load failure', async () => {
    ...
    expect(
      screen.queryByRole('img', { name: 'Latest generated CloserEdge AI architecture diagram' })
