...
/// `"C:\Program Files\CloserEdgeAI\CloserEdgeAI.exe" "%1"` — we want the exe path.
...
mod tests {
    ...
    fn extract_first_token_quoted_exe_with_args() {
        assert_eq!(
            extract_first_token("\"C:\\Program Files\\CloserEdgeAI\\CloserEdgeAI.exe\" \"%1\""),
            "C:\\Program Files\\CloserEdgeAI\\CloserEdgeAI.exe"
        );
    }
    ...
    fn extract_first_token_unquoted_exe_with_args() {
        assert_eq!(
            extract_first_token("C:\\CloserEdgeAI\\CloserEdgeAI.exe %1"),
            "C:\\CloserEdgeAI\\CloserEdgeAI.exe"
        );
    }
    ...
    fn extract_first_token_single_value_no_args() {
        assert_eq!(extract_first_token("CloserEdgeAI.exe"), "CloserEdgeAI.exe");
    }
    ...
    fn extract_first_token_quoted_exe_with_no_trailing_args() {
        ...
        assert_eq!(
            extract_first_token("\"C:\\CloserEdgeAI\\CloserEdgeAI.exe\""),
            "C:\\CloserEdgeAI\\CloserEdgeAI.exe"
        );
    }
    ...
    fn extract_first_token_unterminated_quote_falls_through() {
        ...
        assert_eq!(
            extract_first_token("\"C:\\CloserEdgeAI\\CloserEdgeAI.exe %1"),
            "C:\\CloserEdgeAI\\CloserEdgeAI.exe %1"
        );
    }
    ...
    fn paths_equal_loose_distinguishes_different_paths() {
        assert!(!paths_equal_loose(
            "C:\\OldPath\\CloserEdgeAI.exe",
            "C:\\NewPath\\CloserEdgeAI.exe"
        ));
    }

    #[test]
    fn command_references_exe_matches_quoted_command_with_percent_one() {
        let exe = PathBuf::from("C:\\Program Files\\CloserEdgeAI\\CloserEdgeAI.exe");
        assert!(command_references_exe(
            "\"C:\\Program Files\\CloserEdgeAI\\CloserEdgeAI.exe\" \"%1\"",
            &exe
        ));
    }
    ...
    fn command_references_exe_matches_unquoted_command() {
        ...
        let exe = PathBuf::from("C:\\CloserEdgeAI\\CloserEdgeAI.exe");
        assert!(command_references_exe(
            "C:\\CloserEdgeAI\\CloserEdgeAI.exe %1",
            &exe
        ));
    ...
    fn command_references_exe_detects_stale_install_path() {
        ...
        let exe = PathBuf::from("C:\\NewLocation\\CloserEdgeAI.exe");
        assert!(!command_references_exe(
            "\"C:\\OldLocation\\CloserEdgeAI.exe\" \"%1\"",
            &exe
        ));
    }
    ...
    fn redacted_drops_directory_components_for_stale_paths() {
        ...
        assert!(
            rendered.contains("CloserEdgeAI.exe"),
    ...
    fn redacted_preserves_valid_variant_label_and_basename() {
        let status = RegistrationStatus::Valid {
            command: "\"C:\\Program Files\\CloserEdgeAI\\CloserEdgeAI.exe\" \"%1\"".into(),
        };
        assert_eq!(status.redacted(), "Valid { exe: CloserEdgeAI.exe }");
    }
