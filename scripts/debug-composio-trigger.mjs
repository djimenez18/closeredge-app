...
//                                     the `closeredge-core auth get_session_token`
//                                     fallback)
...
function getSessionTokenFromCore() {
  const coreBin = path.join(ROOT, 'target', 'debug', 'closeredge-core');
...
if (token) {
  ...
  if (token) info('Source', 'target/debug/closeredge-core auth get_session_token');
}
